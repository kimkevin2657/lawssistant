		...
		<div id="hd">
			...
			<div id="gnb">
				<div id="gnb_inner">
					...
					<div class="gnb_li">
						<ul>
                            <li><a href="<?php echo TB_SHOP_URL; ?>/listtype.php?type=4"><?php echo $gw_dp_label['q_type4']; // 15만원 상품 ?></a></li>
                            <li><a href="<?php echo TB_SHOP_URL; ?>/listtype.php?type=5"><?php echo $gw_dp_label['q_type5']; // 40만원 상품  ?></a></li>
                            <li><a href="<?php echo TB_SHOP_URL; ?>/listtype.php?type=3"><?php echo $gw_dp_label['q_type3']; // 반값상품 신상품 ?></a></li>
                            <li><a href="http://shopping.k2k9.co.kr" target="_blank">회원쇼핑몰 <i
                                            style="margin:5px;" class="fa fa-external-link"></i></a></li>
