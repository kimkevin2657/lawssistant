...
<div id="con_lf">
	...
	<div id="smb_my_ov">
		...
		<div id="smb_my_act">
			<ul>
				<li><a href="<?php echo TB_BBS_URL; ?>/register_mod.php" class="btn_lsmall">회원정보수정</a></li>
        ...
        <tr>
            <th scope="row">수수료</th>
            <td colspan="3"><a href="<?php echo asideUrl; ?>/page.phpc?code=partner_paylist"><b><?php
	...
	<span class="fc_00f">현재잔액 : <?php echo number_format($member['pay']); ?>원</span>
        ...
        <tr>
            <th scope="row">라인점수</th>
            <td colspan="3"><a href="<?php echo TB_SHOP_URL; ?>/lpoint.php"><b><?php echo display_point(Member::linePoint($member['id'], 'month'),''); ?>/<?php echo display_point(Member::linePoint($member['id']),'점'); ?></b></a></td>
        </tr>
        <?php endif; ?>
		<tr>
