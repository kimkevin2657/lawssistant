...
<div id="con_lf">
	...
	<nav id="tab_cate">
		<ul id="tab_cate_ul">
			<li<?php echo $selected1; ?>><a href="<?php echo TB_SHOP_URL; ?>/coupon.php">사용가능한 쿠폰</a></li>
			<li<?php echo $selected2; ?>><a href="<?php echo TB_SHOP_URL; ?>/coupon.php?sca=1">사용완료 및 기한만료 쿠폰</a></li>
		</ul>
	</nav>
