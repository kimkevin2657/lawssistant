...
<a href="./minishop_banner_list_update.php?mod_type=R" class="btn_lsmall bx-red" onclick="return default_confirm(this, '');"><i class="fa fa-refresh fa-spin"></i> 본사와 동일하게 설정값 초기화</a>
<a href="./page.php?code=minishop_banner_form" class="fr btn_lsmall red"><i class="ionicons ion-android-add"></i> 추가하기</a>
EOF;
?>
...
<form name="fbannerlist" id="fbannerlist" method="post" action="./minishop_banner_list_update.php" onsubmit="return fbannerlist_submit(this);">
...
<div class="tbl_head01">
	...
	for($i=0; $row=sql_fetch_array($result); $i++) {
		...
		$s_upd = "<a href='./page.php?code=minishop_banner_form&w=u&bn_id=$bn_id$qstr&page=$page' class=\"btn_small\">수정</a>";
