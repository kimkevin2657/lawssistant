...
$storeSp = explode("|", $_POST['store_mb_id']);

$sql_common = " cp_ix = '{$cp_ix}',
                store_mb_id = '{$storeSp[0]}',
                design_idx = '{$storeSp[1]}',
                design_name = '{$storeSp[2]}',
                rmo_name = '{$rmo_name}',
                rmo_unit = '{$rmo_unit}',
                rmo_cnt = '{$rmo_cnt}',
                rmo_memo = '{$rmo_memo}',
...
if ($mode == 'new' || $mode == '') { 
    ...
    goto_url('../rpage.php?code=wzb_room_option_list');
    ...
    goto_url('../rpage.php?code=wzb_room_option_form&mode=edit&rmo_ix='.$rmo_ix.$qstr);
    ...
    goto_url('./rpage.php?code=wzb_room_option_list'.$qstr);
