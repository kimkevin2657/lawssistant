...
<div class="btn_add01 btn_add btn_fixed_top">
    <a href="./rpage.php?code=wzb_room_option_form<?php echo $qstr;?>" id="coupon_add">옵션 등록</a>
</div>
        ...
        for ($z = 0; $z < $cnt_option; $z++) { 
            ...
            <tr>
                ...
                <td class="td_mngsmall">
                    <a href="./rpage.php?code=wzb_room_option_form&mode=edit&rmo_ix=<?php echo $arr_option[$z]['rmo_ix'].$qstr;?>">수정</a>
                    <a href="./rpage.php?code=wzb_room_option_form_update&mode=del&rmo_ix=<?php echo $arr_option[$z]['rmo_ix'].$qstr;?>" onclick="return delete_confirm(this);">삭제</a>
                </td>
            </tr> 
            <?php
        }
