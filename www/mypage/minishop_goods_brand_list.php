...
<h2>브랜드 등록</h2>
<form name="fbrandlist2" id="fbrandlist2" action="./minishop_goods_brand_form_update.php" method="post" enctype="MULTIPART/FORM-DATA">
...
<form name="fbrandlist" id="fbrandlist" method="post" action="./minishop_goods_brand_list_update.php" onsubmit="return fbrandlist_submit(this);">
<input type="hidden" name="q1" value="<?php echo $q1; ?>">
<input type="hidden" name="page" value="<?php echo $page; ?>">
...
<div class="tbl_head01">
	...
	for($i=0; $row=sql_fetch_array($result); $i++) {
		...
		if($row['mb_id'] == $member['id']) {
			$s_upd = "<a href='./page.php?code=minishop_goods_brand_form&w=u&br_id=$br_id$qstr&page=$page' class=\"btn_small\">수정</a>";
			$readonly = "";
			$disabled = "";
	...
	<tr class="<?php echo $bg; ?>">
		...
		<td><?php echo $row['mb_id'] == encrypted_admin() ? "본사":$row['mb_id']; ?></td>
