...
$btn_frmline = <<<EOF
<a href="./minishop_order_admlist_excel.php?$q1" class="btn_lsmall bx-white"><i class="fa fa-file-excel-o"></i> 엑셀저장</a>
EOF;
?>
...
<div class="tbl_head01">
	...
	for($i=0; $row=sql_fetch_array($result); $i++) {
		...
		for($k=0; $row2=sql_fetch_array($res); $k++) {
			...
			$it_href = MS_SHOP_URL.'/view.php?index_no='.$row2['gs_id'];
	?>
