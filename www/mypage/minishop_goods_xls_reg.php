...
<div class="tbl_frm02">
	...
	<tr>
		...
		<td>
			<a href="<?php echo MS_LIB_URL; ?>/Excel/itemexcel2.xls" class="btn_small bx-blue"><i class="fa fa-download"></i> 샘플파일 다운로드</a>
			<a href="./minishop_category_excel.php" class="btn_small bx-blue"><i class="fa fa-download"></i> 카테고리 엑셀다운로드</a>
		</td>
	</tr>
	<tr>
...
function fitemexcel_submit(f)
{
	...
	f.action = "./page.php?code=minishop_goods_xls_reg_update";
	return true;
}
</script>
