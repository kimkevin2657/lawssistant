...
<div class="tbl_frm01">
	...
	<tr>
		...
		<td>
			<input type="submit" name="act_button" value="반품 처리완료" class="btn_medium red" onclick="document.pressed=this.value">
			<input type="submit" name="act_button" value="반품 처리중" class="btn_medium white" onclick="document.pressed=this.value">
			<input type="submit" name="act_button" value="반품 취소후 배송중으로 처리" class="btn_medium white" onclick="document.pressed=this.value">
		</td>
	</tr>
	</tbody>
	</table>
