...
$frm_submit = '<div class="btn_confirm">
	...
	<a href="./page.php?code=minishop_banner_list'.$qstr.'&page='.$page.'" class="btn_large bx-white">목록</a>'.PHP_EOL;
if($w == 'u')
	$frm_submit .= '<a href="./page.php?code=minishop_banner_form" class="btn_large bx-red">추가</a>'.PHP_EOL;
$frm_submit .= '</div>';
?>

<script src="<?php echo MS_JS_URL; ?>/colorpicker.js"></script>

<form name="fbanner" id="fbanner" action="./minishop_banner_form_update.php" method="post" enctype="MULTIPART/FORM-DATA">
