...
<form name="fregform" method="post" action="./minishop_naverpay_update.php">
...
<div class="tbl_frm01">
	...
	<tr>
		...
		<td>   
			<input type="text" name="de_naverpay_mid" value="<?php echo $minishop['de_naverpay_mid']; ?>" id="de_naverpay_mid" class="frm_input" size="20" maxlength="50">
	...
	<tr>
		...
		<td>
			<input type="text" name="de_naverpay_cert_key" value="<?php echo $minishop['de_naverpay_cert_key']; ?>" id="de_naverpay_cert_key" class="frm_input" size="50" maxlength="100">
	...
	<tr>
		...
		<td>                
			<input type="text" name="de_naverpay_button_key" value="<?php echo $minishop['de_naverpay_button_key']; ?>" id="de_naverpay_button_key" class="frm_input" size="50" maxlength="100">
	...
	<tr>
		...
		<td>                
			<input type="text" name="de_naverpay_mb_id" value="<?php echo $minishop['de_naverpay_mb_id']; ?>" id="de_naverpay_mb_id" class="frm_input" size="20" maxlength="20">
	...
	<tr>
		...
		<td>                
			<?php echo MS_SHOP_URL; ?>/naverpay/naverpay_item.php
	...
	<tr>
		...
		<td>                
			<input type="text" name="de_naverpay_sendcost" value="<?php echo $minishop['de_naverpay_sendcost']; ?>" id="de_naverpay_sendcost" class="frm_input" size="60">
...
<div class="information">
	...
	<div class="content">
		...
		<div class="desc01">
			...
			<p>ㆍ네이버페이 비밀번호로 안전하게 결제할 수 있으며 결제할 때마다 적립되는 네이버페이 쇼핑포인트를 다양한 가맹점에서 현금과 동일하게 사용할 수 있습니다.</p>
		</div>
