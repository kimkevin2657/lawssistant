...
<div class="tbl_frm02">
	...
	<tr>
		...
		<td><a href="<?php echo MS_MYPAGE_URL; ?>/seller_order_delivery_excel.php" class="btn_small bx-blue"><i class="fa fa-download"></i> 배송준비 주문내역 다운로드</a></td>
	</tr>
	<tr>
...
<div class="btn_confirm">
	...
	<!--<input type="submit" value="배송정보 등록" class="Shipping_Information_btn">-->
</div>
</form>
...
<div class="information">
	...
	<div class="content">
		<div class="desc02">
			...
			<p>ㆍ배송회사명은 <a href="<?php echo MS_MYPAGE_URL; ?>/page.php?code=seller_baesong"<strong>환경설정 > 배송/교환/반품 설정</strong></a>에 등록된 배송업체명과 반드시 일치해야 합니다.</p>
...
f.action = "./page.php?code=seller_order_delivery_update";
	return true;
}
</script>
