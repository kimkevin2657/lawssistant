...
$sql_search = " where a.use_aff = 1 and a.mb_id = '{$member['id']}' ";
...
<a href="./minishop_goods_list_excel.php?$q1" class="btn_lsmall bx-white"><i class="fa fa-file-excel-o"></i> 엑셀저장</a>
<a href="./page.php?code=minishop_goods_form" class="fr btn_lsmall red"><i class="ionicons ion-android-add"></i> 상품등록</a>
EOF;
?>
...
<form name="fgoodslist" id="fgoodslist" method="post" action="./minishop_goods_list_update.php" onsubmit="return fgoodslist_submit(this);">
...
<div class="tbl_head02">
	...
	<tr class="<?php echo $bg; ?>">
		...
		<td rowspan="2"><a href="./page.php?code=minishop_goods_form&w=u&gs_id=<?php echo $gs_id.$qstr; ?>&page=<?php echo $page; ?>&bak=<?php echo $code; ?>" class="btn_small">수정</a></td>
	</tr>
	<tr class="<?php echo $bg; ?>">
