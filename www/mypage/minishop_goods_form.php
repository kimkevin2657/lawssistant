...
if($w == "u" && $bak) {
	...
	$frm_submit .= '<a href="./page.php?code=minishop_goods_form" class="btn_large bx-red">추가</a>'.PHP_EOL;
}
$frm_submit .= '</div>';
...
<div class="tbl_frm02">
    ...
    <tr>
        ...
        <td colspan="3">
            ₩ <input type="text" name="goods_kv" value="<?php echo number_format($gs['goods_kv']); ?>" class="frm_input w80" readonly onkeyup="addComma(this);">
            ...
            <script>
                function calcGoodsKv(){
                    ...
                    if( goods_price > supply_price ) $('[name=goods_kv]').val( commaStr( new String(Math.round((goods_price - supply_price)*0.4))) );
                }
            </script>
        </td>
    </tr>
...
<div class="tbl_frm02">
	...
	<tr>
		...
		<td>
			...
			<a href="./page.php?code=minishop_baesong" target="_blank" class="btn_small grey">설정</a>
...
function fregform_submit(f) {
	...
	f.action = "./minishop_goods_form_update.php";
    return true;
}
