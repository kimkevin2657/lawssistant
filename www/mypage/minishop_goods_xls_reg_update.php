...
//		$gpoint		= addslashes(trim(conv_number($data->sheets[0]['cells'][$i][$j++]))); // 쇼핑포인트
...
<div class="btn_confirm">
	<a href="./page.php?code=minishop_goods_xls_reg" class="btn_large">확인</a>
</div>
