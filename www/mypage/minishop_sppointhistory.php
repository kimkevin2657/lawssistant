...
$btn_frmline = <<<EOF
<a href="./minishop_sppointhistoryexcel.php?$q1" class="btn_lsmall bx-white"><i class="fa fa-file-excel-o"></i> 엑셀저장</a>
EOF;
?>
...
<div class="tbl_head01">
	...
	<tr>
		...
		<th scope="col"><?php echo subject_sort_link('a.sp_content', $q2); ?>수수료내용</a></th>
		...
		<th scope="col" class="th_bg"><?php echo subject_sort_link('a.sp_price', $q2); ?>수수료</a></th>
		<th scope="col"><?php echo subject_sort_link('a.sp_balance', $q2); ?>수수료합</a></th>
	</tr>
	</thead>
	<?php
	...
	<tr class="<?php echo $bg; ?>">
		...
		<td><?php echo $gw_ptype[$row['sp_rel_table']]; ?></td>
