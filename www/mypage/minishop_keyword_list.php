...
if($w == "reg") {
	...
	goto_url(MS_MYPAGE_URL."/page.php?code=minishop_keyword_list");
}
...
<form name="fregform" method="post" action="./page.php?code=minishop_keyword_list">
...
<form name="fwordlist" id="fwordlist" method="post" action="./minishop_keyword_list_update.php" onsubmit="return fwordlist_submit(this);">
