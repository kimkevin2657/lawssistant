...
<div id="main_wrap">
	<section>
		<h2>전체 주문통계<a href="<?php echo MS_MYPAGE_URL; ?>/page.php?code=seller_odr_list" class="btn_small">주문내역 바로가기</a></h2>
		<div class="order_vbx">
			<dl class="od_bx1">
				<dt>전체 주문현황</dt>
				<dd>
				...
				<dd class="total">
					...
					<?php echo display_price2($sodrr['price']); ?>
				</dd>
			</dl>
	...
	<section class="sidx_head01">
		<h2>최근 주문내역<a href="<?php echo MS_MYPAGE_URL; ?>/page.php?code=seller_odr_list" class="btn_small">주문내역 바로가기</a></h2>
		<table>
		<thead>
		<tr>
	...
	<section>
		...
		<tr>
			<td width="49.5%" valign="top" class="sidx_head01">
				<h2>공지사항<a href="<?php echo MS_BBS_URL; ?>/list.php?boardid=20" class="btn_small">바로가기</a></h2>
				<table>
				<colgroup>
					<col width="20%">
					<col width="80%">
				...
				for($i=0;$row=sql_fetch_array($res);$i++){
					...
					$bo_href = MS_BBS_URL."/read.php?boardid=20&index_no=$row[index_no]";
				?>
				<tr>
			...
			<td width="1%"></td>
			<td width="49.5%" valign="top" class="sidx_head01">
				<h2>질문과답변<a href="<?php echo MS_BBS_URL; ?>/list.php?boardid=21" class="btn_small">바로가기</a></h2>
				<table>
				<colgroup>
					<col width="20%">
					<col width="80%">
				...
				for($i=0;$row=sql_fetch_array($res);$i++){
					$bo_subject = cut_str($row['subject'],40);
					$bo_date = date('Y-m-d', $row['wdate']);
					$bo_href = MS_BBS_URL."/read.php?boardid=21&index_no=$row[index_no]";
				?>
				<tr>
					<td class="tac"><?php echo $bo_date; ?></td>
					<td class="tal"><a href="<?php echo $bo_href; ?>"><?php echo $bo_subject; ?></a></td>
