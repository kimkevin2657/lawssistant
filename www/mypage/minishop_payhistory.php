...
$btn_frmline = <<<EOF
<a href="./minishop_payhistoryexcel.php?$q1" class="btn_lsmall bx-white"><i class="fa fa-file-excel-o"></i> 엑셀저장</a>
EOF;
?>
...
<div class="tbl_frm01">
	...
	<tr>
		...
		<td>
            ...
            <?php if( ! (defined('USE_ANEWMATCH') && USE_ANEWMATCH) ) unset($gw_ptype2['anew_match']);  ?>
            <?php foreach($gw_ptype2 as $val=>$alias) : ?>
...
<div class="tbl_head01">
	...
	<tr class="<?php echo $bg; ?>">
		...
		<td><?php echo $gw_ptype2[$row['pp_rel_table']]; ?></td>
