...
if($w == "") {
	...
	goto_url(MS_MYPAGE_URL."/page.php?code=minishop_banner_form&w=u&bn_id=$bn_id");
} else if($w == "u") {
	update("shop_banner", $value," where bn_id='$bn_id'");

	goto_url(MS_MYPAGE_URL."/page.php?code=minishop_banner_form&w=u&bn_id=$bn_id$qstr&page=$page");
}
?>