...
<form name="fregform" method="post" action="./minishop_goods_qa_form_update.php" autocomplete="off">
...
<div class="tbl_frm02">
	...
	<tr>
		<th scope="row">상품명</th>
		<td><a href="<?php echo MS_SHOP_URL; ?>/view.php?index_no=<?php echo $iq['gs_id']; ?>" target="_blank"><?php echo $gs['gname']; ?></a></td>
	</tr>
	<tr>
...
<div class="btn_confirm">
	...
	<a href="./page.php?code=minishop_goods_qa<?php echo $qstr; ?>&page=<?php echo $page; ?>" class="btn_large bx-white">목록</a>
</div>
</form>
