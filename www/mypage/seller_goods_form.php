...
<div class="tbl_frm02">
    ...
    <tr>
        ...
        <td colspan="3">
            <input type="text" name="goods_kv" value="<?php echo number_format($gs['goods_kv']); ?>" class="frm_input w80" onkeyup="addComma(this);" readonly style="background-color:#ddd;"> 원
			<input type="text" name="goods_kv_per" class="frm_input w50" value="<?php echo number_format($gs['goods_kv_per']); ?>" readonly style="background-color:#ddd;"> %
	...
	<tr>
		...
		<td colspan="3">
			<input type="text" name="gpoint" value="<?php echo number_format($gs['gpoint']); ?>" class="frm_input w80" onkeyup="addComma(this);" readonly style="background-color:#ddd;"> P
			<input type="text" name="gpoint_per" class="frm_input w50" value="<?php echo number_format($gs['gpoint_per']); ?>" readonly style="background-color:#ddd;"> %
    ...
    <tr>
        ...
        <td colspan="3">
            ...
            <input type="checkbox" id="point_pay_allow_checker" name="point_pay_allow_checker" <?php if( $gs['point_pay_allow'] == '1' ) echo ' checked="checked" '; ?> value="1" disabled>
            <label for="point_pay_allow_checker">쇼핑포인트결제 허용</label>

            <label for="point_pay_point" class="marl30">사용쇼핑포인트</label>
            <input type="number" name="point_pay_point" id="point_pay_point" class="frm_input w80" size="10" value="<?php echo $gs['point_pay_point']; ?>" readonly style="background-color:#ddd;">P
            <input type="number" name="point_pay_per" id="point_pay_per" class="frm_input w50" size="2" value="<?php echo $gs['point_pay_per']; ?>" readonly style="background-color:#ddd;">%
			<span class="fc_197 marl5">P와 % 둘다 입력되어있는 경우 %를 기준으로합니다.</span>
            <script>
                (function($){
