...
$value['goods_kv']	    = conv_number($_POST['goods_kv']); //판매가격
...
if($w == "")
    goto_url(MS_MYPAGE_URL."/page.php?code=minishop_goods_form&w=u&gs_id=$gs_id");
else if($w == "u")
    goto_url(MS_MYPAGE_URL."/page.php?code=minishop_goods_form&w=u&gs_id=$gs_id$q1&page=$page&bak=$bak");
?>