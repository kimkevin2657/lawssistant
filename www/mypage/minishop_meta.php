...
<form name="fregform" method="post" action="./minishop_meta_update.php">
...
<div class="tbl_frm01">
	...
	<tr>
		...
		<td>
			<input type="text" name="head_title" value="<?php echo $minishop['head_title']; ?>" class="frm_input" size="60">
	...
	<tr>
		...
		<td>
			<input type="text" name="meta_author" value="<?php echo $minishop['meta_author']; ?>" class="frm_input" size="60">
	...
	<tr>
		...
		<td>
			<input type="text" name="meta_description" value="<?php echo $minishop['meta_description']; ?>" class="frm_input" size="60">
	...
	<tr>
		...
		<td>
			<textarea name="meta_keywords" class="frm_textbox wfull" rows="5"><?php echo $minishop['meta_keywords']; ?></textarea>
	...
	<tr>
		...
		<td>
			<textarea name="add_meta" class="frm_textbox wfull" rows="5"><?php echo $minishop['add_meta']; ?></textarea>
...
<div class="tbl_frm01">
	...
	<tr>
		...
		<td>
			<textarea name="head_script" class="frm_textbox wfull" rows="5"><?php echo $minishop['head_script']; ?></textarea>
	...
	<tr>
		...
		<td>
			<textarea name="tail_script" class="frm_textbox wfull" rows="5"><?php echo $minishop['tail_script']; ?></textarea>
