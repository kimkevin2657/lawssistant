...
<a href="./minishop_mbanner_list_update.php?mod_type=R" class="btn_lsmall bx-red" onclick="return default_confirm(this, '');"><i class="fa fa-refresh fa-spin"></i> 본사와 동일하게 설정값 초기화</a>
<a href="./page.php?code=minishop_mbanner_form" class="fr btn_lsmall red"><i class="ionicons ion-android-add"></i> 추가하기</a>
EOF;
?>
...
<form name="fmbannerlist" id="fmbannerlist" method="post" action="./minishop_mbanner_list_update.php" onsubmit="return fmbannerlist_submit(this);">
...
<div class="tbl_head01">
	...
	for($i=0; $row=sql_fetch_array($result); $i++) {
		...
		$bimg_str = '';
		$bimg = MS_DATA_PATH."/banner/{$row['bn_file']}";
		...
		$s_upd = "<a href='./page.php?code=minishop_mbanner_form&w=u&bn_id=$bn_id$qstr&page=$page' class=\"btn_small\">수정</a>";
