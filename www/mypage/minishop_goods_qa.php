...
<form name="fqalist" id="fqalist" method="post" action="./minishop_goods_qa_delete.php" onsubmit="return fqalist_submit(this);">
...
<div class="tbl_head01">
	...
	for($i=0; $row=sql_fetch_array($result); $i++) {
		...
		$iq_url = "code=minishop_goods_qa_form&w=u&iq_id=$iq_id$qstr&page=$page";
