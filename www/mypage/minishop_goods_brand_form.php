...
<form name="fregform" method="post" action="./minishop_goods_brand_form_update.php" enctype="MULTIPART/FORM-DATA">
...
<div class="tbl_frm02">
	...
	<tr>
		...
		<td>
			...
			<?php
			$file = MS_DATA_PATH.'/brand/'.$br['br_logo'];
			if(is_file($file) && $br['br_logo']) {
				$br_logo = rpc($file, MS_PATH, MS_URL);
			?>
...
<div class="btn_confirm">
	...
	<a href="./page.php?code=minishop_goods_brand_list<?php echo $qstr; ?>&page=<?php echo $page; ?>" class="btn_large bx-white">목록</a>
</div>
</form>
