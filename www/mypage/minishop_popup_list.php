...
<a href="./page.php?code=minishop_popup_form" class="fr btn_lsmall red"><i class="ionicons ion-android-add"></i> 추가하기</a>
EOF;
?>
...
<form name="fpopuplist" id="fpopuplist" method="post" action="./minishop_popup_list_update.php" onsubmit="return fpopuplist_submit(this);">
...
<div class="tbl_head01">
	...
	for($i=0; $row=sql_fetch_array($result); $i++) {
		...
		$s_upd = "<a href='./page.php?code=minishop_popup_form&w=u&pp_id=$pp_id$qstr&page=$page' class=\"btn_small\">수정</a>";
