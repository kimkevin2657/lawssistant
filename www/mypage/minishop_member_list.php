...
$is_intro = false;
$colspan = 12;
if($config['cert_admin_yes'] && $config['cert_minishop_yes']) {
	$is_intro = true;
	$colspan++;
}

$btn_frmline = <<<EOF
<a href="./minishop_member_list_excel.php?$q1" class="btn_lsmall bx-white"><i class="fa fa-file-excel-o"></i> 엑셀저장</a>
EOF;
...
<div class="tbl_head01">
	...
	<tr class="<?php echo $bg; ?>">
		...
		<td><a href="<?php echo MS_ADMIN_URL; ?>/help/sendmail2.php?mail=<?php echo $row['email']; ?>" onclick="win_open(this,'pop_email','750','680','no'); return false"><img src="<?php echo MS_ADMIN_URL; ?>/img/bt_item_email.gif"></a></td>	
