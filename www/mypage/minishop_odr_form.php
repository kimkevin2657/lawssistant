...
$default = set_minishop_value($od['od_settle_pid']); // 가맹점 PG결제 정보
...
<div id="sodr_pop" class="new_win">
	...
	<section id="anc_sodr_list">
		...
		<div class="local_desc02 local_desc">
			<p>
				...
				<a href="javascript:win_open('<?php echo MS_MYPAGE_URL; ?>/minishop_odr_print.php?od_id=<?php echo $od_id; ?>','order_print','670','600','yes');" class="btn_small blue fr"><i class="fa fa-print"></i> 주문서출력</a>
			</p>
		</div>

		<form name="frmorderform" method="post" action="./minishop_odr_statusupdate.php" onsubmit="return form_submit(this);">
		...
		<div class="tbl_head01">
			...
			<tr class="<?php echo $bg; ?>">
				...
				<td>
					<a href="<?php echo MS_SHOP_URL; ?>/view.php?index_no=<?php echo $row['gs_id']; ?>" target="_blank"><?php echo get_od_image($row['od_id'], $gs['simg1'], 40, 40); ?></a>
				</td>
				<td class="tal">
					<a href="<?php echo MS_MYPAGE_URL; ?>/page.php?code=minishop_goods_form&w=u&gs_id=<?php echo $row['gs_id']; ?>" target="_blank"><?php echo get_text($gs['gname']); ?></a>
				...
				<td>
					...
					<p class="padt3"><a href="<?php echo MS_ADMIN_URL; ?>/pop_orderpartcancel.php?od_id=<?php echo $row['od_id']; ?>&od_no=<?php echo $row['od_no']; ?>" class="btn_ssmall orderpartcancel red">PG부분취소</a></p>
					<?php } ?>
				</td>
	...
	<section id="anc_sodr_pay" class="new_win_desc mart30">
		...
		<?php echo $pg_anchor; ?>
		<form name="frmorderreceiptform" action="./minishop_odr_formupdate.php" method="post" autocomplete="off">
		<input type="hidden" name="od_id" value="<?php echo $od_id; ?>">
		...
		<div class="compare_wrap">
			...
			<section id="anc_sodr_paymo" class="compare_right">
				...
				<div class="tbl_frm01">
					...
					<?php if($pf_auth_pg && ($od['od_settle_pid'] == $member['id']) && !in_array($od['paymethod'], array('무통장', '쇼핑포인트'))) { ?>
					<tr>
	...
	<section id="anc_sodr_memo">
		...
		<form name="frmorderform3" action="./minishop_odr_formupdate.php" method="post">
		<input type="hidden" name="od_id" value="<?php echo $od_id; ?>">
	...
	<section id="anc_sodr_addr">
		...
		<form name="frmorderform2" action="./minishop_odr_formupdate.php" method="post">
		<input type="hidden" name="od_id" value="<?php echo $od_id; ?>">
...
function form_submit(f)
{
	...
	if(status == "운송장번호수정") {
		f.action = "./minishop_odr_baesongupdate.php";
		return true;
	}
