...
<div class="tbl_frm01 tbl_wrap">
	...
	<tr>
		...
		<td><input type="text" name="etc_1" value="<?php echo $write['etc_1']; ?>" class="frm_input wfull"></td>
	</tr>
	<tr>
		<th scope="row">YOUTUBE 주소</th>
		<td><input type="text" name="etc_2" value="<?php echo $write['etc_2']; ?>" class="frm_input wfull"></td>
	</tr>
	<tr>
		<th scope="row">내용</th>
		<td>
