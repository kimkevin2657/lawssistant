...
<div class="tbl_frm01 tbl_wrap">
	...
	<?php if($bo_file1) { ?>
	<tr>
		<td>첨부파일1 : <a href="./download.php?file=<?php echo $bo_file1; ?>&mid=<?php  echo $boardid; ?>&url=<?php echo MS_DATA_URL; ?>/board/<?php echo $boardid; ?>/<?php echo $bo_file1; ?>"><b><?php echo $bo_file1; ?></b></a></td>
	</tr>
	<?php } ?>
	<?php if($bo_file2) { ?>
	<tr>
		<td>첨부파일2 : <a href="./download.php?file=<?php echo $bo_file2; ?>&mid=<?php  echo $boardid; ?>&url=<?php echo MS_DATA_URL; ?>/board/<?php echo $boardid; ?>/<?php echo $bo_file2; ?>"><b><?php echo $bo_file2; ?></b></a></td>
	</tr>
	<?php } ?>
	<tr>
		<td style="height:200px;vertical-align:top;">
    <div class="view_movie"><iframe width="600" height="480" src="<?=$write['etc_2']?>" frameborder="0" allowfullscreen></iframe></div>
    <br/>
		<?php
		...
		?>
		<a href="javascript:imgview('<?php echo MS_DATA_URL; ?>/board/<?php echo $boardid; ?>/<?php echo $bo_file1; ?>');"><img src="<?php echo MS_DATA_URL; ?>/board/<?php echo $boardid; ?>/<?php echo $bo_file1; ?>" width="<?php echo $width; ?>" height="<?php echo $height; ?>"></a><br><br>
		<?php
		}
		...
		?>
		<a href="javascript:imgview('<?php echo MS_DATA_URL; ?>/board/<?php echo $boardid; ?>/<?php echo $bo_file2; ?>');"><img src="<?php echo MS_DATA_URL; ?>/board/<?php echo $boardid; ?>/<?php echo $bo_file2; ?>" width="<?php echo $width; ?>" height="<?php echo $height; ?>"></a>
		<?php
		}
