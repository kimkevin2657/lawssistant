...
/* add_stylesheet('<link rel="stylesheet" href="'.G5_BBS_URL.'/skin/schedule/custom.css">', 0);
...
?>
<link rel="stylesheet" href="<? echo G5_BBS_URL; ?>/skin/schedule/custom.css">

<script src="https://cdn.jsdelivr.net/npm/@fullcalendar/core@4.3.1/main.min.js"></script>
<script src="https://cdn.jsdelivr.net/npm/@fullcalendar/core@4.3.1/locales-all.min.js"></script>
...
<script src="https://cdn.jsdelivr.net/npm/@fullcalendar/bootstrap@4.3.0/main.min.js"></script>

<link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/@fullcalendar/core@4.3.1/main.min.css">
<link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/@fullcalendar/daygrid@4.3.0/main.min.css">
<link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/@fullcalendar/bootstrap@4.3.0/main.min.css">
...
<div class="d-flex justify-content-end mb-4">
	<div class="btn-group xs-100">
		<?php if($is_admin) { ?><a href="<?php echo MS_BBSORG_URL; ?>/write.php?bo_table=schedule" class="btn btn-primary"><i class="fa fa-pen" aria-hidden="true"></i> 글쓰기</a><?php } ?>
	</div>
</div>

<script>
$(document).ready(function() {
	var skin_url = "<? echo G5_BBS_URL; ?>/skin/schedule";
	...
	var calendar = new FullCalendar.Calendar(calendarEl, {
			...
			events: skin_url+'/list.json.php?bo_table=<?php echo $bo_table; ?>'
