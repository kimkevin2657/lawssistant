...
$(document).ready(function() {
	...
	rumiTable.rumiLoad({
		...
		items : [
            ...
            { selector:'standard', type:'text', number:false },
...
<table>
	...
	<tbody class="work_item">
		<tr>
            ...
            <td><input type="text" name="doc_standard[]" class="doc_standard insTab td_center" value="" /></td>
