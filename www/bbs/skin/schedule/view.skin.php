...
<article id="bo_v" style="width:<?php echo $width; ?>">
    ...
    <section id="bo_v_info">
        <h2>페이지 정보</h2>
        <span class="sound_only">작성자</span> <strong><?php echo substr($view['wr_name'],0,-3)."*"; ?><?php if ($is_ip_view) { echo "&nbsp;($ip)"; } ?></strong>
...
<!--     <div id="bo_v_share">
    ...
    <div id="bo_v_top">
	    ...
	    <ul class="bo_v_com">
        <?
            $update_href = MS_BBSORG_URL."/write.php?w=u&bo_table=schedule&wr_id=".$write['wr_id'];
            //$delete_href = MS_BBSORG_URL."/delete.php?bo_table=schedule&wr_id=".$write['wr_id'];
        ?>
