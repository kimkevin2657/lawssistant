...
<section id="bo_w">
    <!-- 게시물 작성/수정 시작 { -->
    <form name="fwrite" id="fwrite" action="<? echo MS_BBSORG_URL; ?>/write_update.php" onsubmit="return fwrite_submit(this);" method="post" enctype="multipart/form-data" autocomplete="off" style="width:<?php echo $width; ?>">
    ...
    <div class="tbl_frm01 tbl_wrap">
        ...
        <tr>
            <th scope="row"><label for="wr_3">권한<strong class="sound_only">필수</strong></label></th>
            <td>
                <div id="autosave_wrapper">
                    <?php echo get_member_select("wr_3", $write['wr_3']); ?>
                </div>
            </td>
        </tr>
    ...
    <div class="btn_confirm write_div">
        <a href="<? echo MS_BBS_URL; ?>/board.php?bo_table=<?php echo $bo_table ?>" class="btn_cancel btn">취소</a>
