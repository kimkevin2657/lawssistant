...
$sms['user_id'] = "ink6067"; // SMS 아이디
$sms['key'] = "tcjpb8gb4vkkog5p63608lucnrnci97q";//인증키
/****************** 인증정보 끝 ********************/

/****************** 전송정보 설정시작 ****************/
$_POST['msg'] = 'test msg'; // 메세지 내용 : euc-kr로 치환이 가능한 문자열만 사용하실 수 있습니다. (이모지 사용불가능)
$_POST['receiver'] = '01081070824'; // 수신번호
$_POST['destination'] = '01111111111|담당자,01111111112|홍길동'; // 수신인 %고객명% 치환
$_POST['sender'] = "16612550"; // 발신번호
$_POST['rdate'] = ''; // 예약일자 - 20161004 : 2016-10-04일기준
$_POST['rtime'] = ''; // 예약시간 - 1930 : 오후 7시30분
$_POST['testmode_yn'] = 'Y'; // Y 인경우 실제문자 전송X , 자동취소(환불) 처리
$_POST['subject'] = '테스트'; //  LMS, MMS 제목 (미입력시 본문중 44Byte 또는 엔터 구분자 첫라인)
