...
<div id="con_lf">
	...
	<p class="pg_cnt">
		<em>총 <?php echo number_format($total_count); ?>건</em>의 Oh!포인트 내역이 있습니다.
		<a href="/bbs/board.php?bo_table=chargepoint" class="navbar-inqry">Oh!포인트 충전</a>
	</p>
	...
	<div class="tbl_head02 tbl_wrap">
		...
		<tr>
			<th scope="col">일시</th>
			<th scope="col">내용</th>
			<th scope="col">지급 Oh!포인트</th>
			<th scope="col">사용 Oh!포인트</th>
		</tr>
		</thead>
		<tbody>
		<?php
		...
		<tr>
			<th scope="row" colspan="2">보유 Oh!포인트</th>
