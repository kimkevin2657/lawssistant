...
<div id="con_lf">
	...
	<div class="btn_confirm">
		<a href="<?php echo MS_BBS_URL; ?>/qna_write.php" class="btn_lsmall">상담문의하기</a>
		<a href="<?php echo MS_BBS_URL; ?>/qna_modify.php?index_no=<?php echo $index_no; ?>" class="btn_lsmall bx-white">수정</a>
		<a href="<?php echo MS_BBS_URL; ?>/qna_list.php" class="btn_lsmall bx-white">목록</a>
		<a href="javascript:del('<?php echo MS_BBS_URL; ?>/qna_read.php?index_no=<?php echo $index_no; ?>&mode=d');" class="btn_lsmall bx-white">삭제</a>
	</div>
</div>
