...
<div id="con_lf">
	...
	<nav id="tab_cate">
		<ul id="tab_cate_ul">
			<li<?php echo $selected1; ?>><a href="<?php echo MS_SHOP_URL; ?>/coupon.php">사용가능한 쿠폰</a></li>
			<li<?php echo $selected2; ?>><a href="<?php echo MS_SHOP_URL; ?>/coupon.php?sca=1">사용완료 및 기한만료 쿠폰</a></li>
		</ul>
	</nav>
	...
	<div class="tbl_head02 tbl_wrap">
		...
		<tr class="<?php echo $bg; ?>">
			...
			<td><a href='<?php echo MS_SHOP_URL; ?>/coupon_goods.php?lo_id=<?php echo $row['lo_id']; ?>' onclick="win_open(this,'coupon_goods','800','800','yes');return false;"><?php echo get_text(cut_str($row['cp_subject'],44)); ?></a></td>
