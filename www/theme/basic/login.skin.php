...
<div class="login_wrap" id="login_fld">		
	<dl class="log_inner">
		...
		<!--dd><a href="<?php echo MS_SHOP_URL; ?>/orderform.php" class="btn_large red wfull">비회원으로 구매하기</a></dd-->
		<?php } ?>
		<dd class="log_op">
			<span><input type="checkbox" name="auto_login" id="login_auto_login"> <label for="login_auto_login">자동로그인</label></span>	
			<span class="fr"><a href="<?php echo MS_BBS_URL; ?>/password_lost.php" onclick="win_open(this,'pop_password_lost','500','400','no');return false;">아이디 / 비밀번호 찾기</a></span>
		</dd>
	</dl>
	...
	<div class="sns_btn">
		...
		<?php } ?>
        <?php if($default['de_googl_appid'] && $default['de_googl_secret']) { ?>
...
<form name="forderinquiry" method="post" action="<?php echo MS_SHOP_URL; ?>/orderinquiry.php" autocomplete="off">
...
<div class="log_bt_box">
	...
	<a href="<?php echo MS_BBS_URL; ?>/register.php" class="btn_lsmall bx-white marl15">회원가입</a>
</div>
