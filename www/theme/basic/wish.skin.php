...
<div id="con_lf">
	...
	<div class="tbl_head02 tbl_wrap">
		...
		<tr>
			...
			<td class="tac"><a href="<?php echo MS_SHOP_URL; ?>/view.php?index_no=<?php echo $row['gs_id']; ?>"><?php echo get_it_image($row['gs_id'], $row['simg1'], 70, 70); ?></a></td>
			<td class="td_name">
				<a href="<?php echo MS_SHOP_URL; ?>/view.php?index_no=<?php echo $row['gs_id']; ?>"><?php echo $row['gname']; ?></a>
				<p class="fc_999"><?php echo $row['explan']; ?></p>
			</td>			
			<td class="tar"><?php echo get_price($row['gs_id']); ?></td>
			<td class="tac"><a href="<?php echo MS_SHOP_URL; ?>/wishupdate.php?w=d&wi_id=<?php echo $row['wi_id']; ?>" class="btn_small bx-red">삭제</td>
		</tr>
		<?php
		} 
		if($i==0) 
