...
if($is_kakaopay_use) {
	require_once(MS_SHOP_PATH.'/kakaopay/orderform.1.php');
}
?>
...
<?php
if($is_kakaopay_use) {
	require_once(MS_SHOP_PATH.'/kakaopay/orderform.2.php');
}
?>
...
<?php
if($is_kakaopay_use) {
	require_once(MS_SHOP_PATH.'/kakaopay/orderform.3.php');
} else {
