...
<div id="con_lf">
	...
	<div class="tar marb5">
		<a href="<?php echo MS_BBS_URL; ?>/qna_write.php" class="btn_small wset">상담문의하기</a>
	</div>
	...
	<div class="tbl_head02 tbl_wrap">
		...
		<tr class="<?php echo $bg; ?>">
			...
			<td><a href="<?php echo MS_BBS_URL; ?>/qna_read.php?index_no=<?php echo $row['index_no']; ?>"><?php echo cut_str($row['subject'],60); ?></a></td>
