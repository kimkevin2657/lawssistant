			...
			<dl class="cswrap">
          	...
          	<dl class="bkwrap">
				...
				<!--dd class="etc_btn">
					...
					<a href="<?php echo MS_BBS_URL; ?>/minishop_reg.php" class="btn_lsmall">분양몰신청 하기</a>
					<?php } ?>

					<?php if($config['seller_reg_yes']) { ?>
					<a href="<?php echo MS_BBS_URL; ?>/seller_reg.php" class="btn_lsmall">입점신청 하기</a>
					<?php } ?>
				</dd-->
			</dl>
			<dl class="notice">
				<dt class="tit">공지사항 <a href="<?php echo MS_BBS_URL; ?>/list.php?boardid=13" class="bt_more">더보기 <i class="fa fa-angle-right"></i></a></dt>
				<?php echo board_latest(13, 100, 4, $pt_id); ?>
			</dl>
		</div>
		<div class="fgnb">
			<ul>
				<li><a href="<?php echo MS_BBS_URL; ?>/content.php?co_id=1">회사소개</a></li>
				<li><a href="<?php echo MS_BBS_URL; ?>/provision.php">이용약관</a></li>
				<li><a href="<?php echo MS_BBS_URL; ?>/policy.php">개인정보처리방침</a></li>
				<li><a href="<?php echo MS_BBS_URL; ?>/faq.php?faqcate=1">고객센터</a></li>
				<li><a href="<?php echo MS_BBS_URL; ?>/minishop_reg.php">미니샵신청</a></li>
				<li><a href="<?php echo MS_BBS_URL; ?>/faq.seller_reg.php">공급사신청</a></li>
				<!--li class="sns_wrap">
					<?php if($default['de_sns_facebook']) { ?><a href="<?php echo $default['de_sns_facebook']; ?>" target="_blank" class="sns_fa"><img src="<?php echo MS_THEME_URL; ?>/img/sns_fa.png" title="facebook"></a><?php } ?>
					<?php if($default['de_sns_twitter']) { ?><a href="<?php echo $default['de_sns_twitter']; ?>" target="_blank" class="sns_tw"><img src="<?php echo MS_THEME_URL; ?>/img/sns_tw.png" title="twitter"></a><?php } ?>
					<?php if($default['de_sns_instagram']) { ?><a href="<?php echo $default['de_sns_instagram']; ?>" target="_blank" class="sns_in"><img src="<?php echo MS_THEME_URL; ?>/img/sns_in.png" title="instagram"></a><?php } ?>
					<?php if($default['de_sns_pinterest']) { ?><a href="<?php echo $default['de_sns_pinterest']; ?>" target="_blank" class="sns_pi"><img src="<?php echo MS_THEME_URL; ?>/img/sns_pi.png" title="pinterest"></a><?php } ?>
					<?php if($default['de_sns_naverblog']) { ?><a href="<?php echo $default['de_sns_naverblog']; ?>" target="_blank" class="sns_bl"><img src="<?php echo MS_THEME_URL; ?>/img/sns_bl.png" title="naverblog"></a><?php } ?>
					<?php if($default['de_sns_naverband']) { ?><a href="<?php echo $default['de_sns_naverband']; ?>" target="_blank" class="sns_ba"><img src="<?php echo MS_THEME_URL; ?>/img/sns_ba.png" title="naverband"></a><?php } ?>
					<?php if($default['de_sns_kakaotalk']) { ?><a href="<?php echo $default['de_sns_kakaotalk']; ?>" target="_blank" class="sns_kt"><img src="<?php echo MS_THEME_URL; ?>/img/sns_kt.png" title="kakaotalk"></a><?php } ?>
					<?php if($default['de_sns_kakaostory']) { ?><a href="<?php echo $default['de_sns_kakaostory']; ?>" target="_blank" class="sns_ks"><img src="<?php echo MS_THEME_URL; ?>/img/sns_ks.png" title="kakaostory"></a><?php } ?>
				</li-->
			</ul>
		</div>
...
<?php
if(MS_DEVICE_BUTTON_DISPLAY && !MS_IS_MOBILE && is_mobile()) { ?>
<a href="<?php echo MS_URL; ?>/index.php?device=mobile" id="device_change">모바일 버전으로 보기</a>
<?php } ?>
</div>