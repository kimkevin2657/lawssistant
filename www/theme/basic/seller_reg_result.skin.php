...
<div><img src="<?php echo MS_IMG_URL; ?>/seller_reg_result.gif"></div>

<h3 class="anc_tit mart20">사업자정보</h3>
...
<h3 class="anc_tit mart30">입금계좌정보</h3>
<div class="tbl_frm01 tbl_wrap">
	<table>
	<colgroup>
		<col class="w140">
...
<h3 class="anc_tit mart30">담당자정보</h3>
<div class="tbl_frm01 tbl_wrap">
	<table>
	<colgroup>
		<col class="w140">
...
<div class="btn_confirm">
	<a href="<?php echo MS_URL; ?>" class="btn_large wset">확인</a>
</div>
