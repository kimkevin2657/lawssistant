  ...
  <input type="hidden" name="od_id" value="<?php echo $od_id; ?>">
	...
	<div class="tbl_frm01 tbl_wrap">
		...
		<tr>
			...
			<td><input type="file" name="photo_file_1" accept="image/jpeg, image/jpg, image/png"></td>
		</tr>
		<tr>
			<th scope="row">사진첨부 #2</th>
			<td><input type="file" name="photo_file_2" accept="image/jpeg, image/jpg, image/png"></td>
		</tr>
		<tr>
			<th scope="row">사진첨부 #3</th>
			<td><input type="file" name="photo_file_3" accept="image/jpeg, image/jpg, image/png"></td>
		</tr>
		</tbody>
		</table>
	</div>
