...
<div id="con_lf">
	...
	<div class="tbl_frm01 tbl_wrap">
		<table>
		<colgroupregister_modregister_mo>
			<col class="w140">
			<col>
		</colgroupregister_modregister_mo>
		<tbody>
		<tr>
			<th scope="row">회원명</th>
			<td><input type="text" name="name" value="<?php echo $member['name']; ?>" <?php echo $readonly1; ?> class="frm_input" size="20"></td>
		</tr>
		<tr>
			<th scope="row">아이디</th>
...
<?php if(!$member['pt_id'] or $member['pt_id']=='') { ?>
		<tr>
			...
			<td>
				<input type="text" name="prt_id" id="prt_id" class="frm_input required" onkeyup="reg_prt_id_ajax();" size="20"  maxlength="20"></span>
				<span id="msg_prt_id" class="marl5"></span>
				<span class="frm_info" id="redN">※ 기업코드/추천인아이디 또는 기업명/단체명에서 부여받은 이름(한글 또는 영문 코드)을 입력하세요.</span>
			</td>
		</tr>
<?php } ?>
 ...
 <?php } ?>
	...
	<div class="tbl_frm01 tbl_wrap">
		...
		<tr>
			...
			<td>
				<input type="text" name="cellphone" value="<?php echo $member['cellphone']; ?>"<?php echo $config['register_req_hp']?' required':''; ?> itemname="휴대전화" class="frm_input<?php echo $config['register_req_hp']?' required':''; ?>" size="20"><span id="redN">&nbsp;&nbsp;&nbsp;필수</span>
		...
		<tr>
			<th scope="row">이메일</th>
			<td>
				<input type="text" name="email" value="<?php echo $member['email']; ?>"<?php echo $config['register_req_email']?' required':''; ?> email itemname="이메일" class="frm_input<?php echo $config['register_req_email']?' required':''; ?>" size="40"><span id="redN">&nbsp;&nbsp;&nbsp;필수</span>
				<input type="checkbox" value="Y" name="mailser" class="marl7"<?php echo $member['mailser'] == 'Y'?' checked':''; ?>> E-Mail을 수신합니다. / 비밀번호 분실 시 메일로 확인 가능
			</td>
		</tr>
		<?php } ?>
		...
		<tr>
			...
			<td>
				<div>
					...
					<a href="javascript:win_zip('fregisterform', 'zip', 'addr1', 'addr2', 'addr3', 'addr_jibeon');" class="btn_small grey marl3">주소검색</a><span id="redN">&nbsp;&nbsp;&nbsp;필수</span>
				</div>
				<div class="mart5">
	...
	<div class="tbl_frm01 tbl_wrap">
		...
		<tr>
			<th scope="row">은행명</th>
			<td>
				<input type="text" name="refund_account_bank_name" value="<?php echo $member['refund_account_bank_name']; ?>" required class="frm_input required" size="20"><span id="redN">&nbsp;&nbsp;&nbsp;필수</span>
			</td>
		</tr>
		<tr>
			<th scope="row">계좌번호</th>
			<td>
				<input type="text" name="refund_account" value="<?php echo $member['refund_account']; ?>" required class="frm_input required" size="30"><span id="redN">&nbsp;&nbsp;&nbsp;필수</span>
			</td>
		</tr>
		<tr>
			<th scope="row">예금주</th>
			<td>
				<input type="text" name="refund_account_name" value="<?php echo $member['refund_account_name']; ?>" required class="frm_input required" size="20"><span id="redN">&nbsp;&nbsp;&nbsp;필수</span>
			</td>
		</tr>
		</tbody>
		</table>
