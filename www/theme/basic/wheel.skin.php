...
<div class="wrap_wheel">
     <div class="bg">
	<img src="<?php echo MS_IMG_URL; ?>/wheel/bg.png">
    </div>
	<div class="ment2">		
		<img src="<?php echo MS_IMG_URL; ?>/wheel/wheel_ment.png">
	</div>
    
		<div class="wheel-wrap">
		<img class="wheel" src="<?php echo MS_IMG_URL; ?>/wheel/img_wheel.png">
		<img class="marker" src="<?php echo MS_IMG_URL; ?>/wheel/marker.png">
<div class="text-on-img">
  <div class="background-wrap">
    <div class="content">
      <span class="content1"><i class="fa fa-credit-card marr5"></i><?php echo $member['name']; ?>님의  누적 oh!포인트 <a href="<?php echo MS_SHOP_URL; ?>/point.php"><b><?php echo display_point($member['point']); ?></b></a></span>
      ...
      <span>*포인트는 마이페이지에서 적립된 내역을 확인가능합니다.</span>
...
<!--div class="wrap_wheel_pc">
	<div class="wrap_wheel">
		<img src="img/bg.png" class="bg" alt="" />
		<div class="ment2">
			<img src="img/wheel_ment.png">
		</div>
        
		
		<div class="wheel-wrap">
			<img class="wheel" src="img/img_wheel.png">
...
<!--div class="wrap_wheel">
	...
	<div class="ment2">		
		<img src="img/wheel_ment.png" style="width:293px;">
	</div>
		<div class="wheel-wrap" style="margin-top:50px;">
		<img class="wheel" src="img/img_wheel.png" style="width: 294px; transform: rotate(0deg);">
		<img class="marker" src="img/marker.png" style="width:25px">
	</div>
</div> -->
