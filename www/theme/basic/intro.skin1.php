...
<div id="intro">
	<div id="int_wrap">
		<div class="lcont">
			...
			<div class="int_btn">
				<a href="<?php echo MS_BBS_URL; ?>/register.php" class="btn_lsmall grey">회원가입</a>
				<a href="<?php echo MS_BBS_URL; ?>/password_lost.php" onclick="win_open(this,'pop_password_lost','500','400','no');return false;" class="btn_lsmall bx-white">아이디/비밀번호 찾기</a>
			</div>
			<ul class="int-txt">
