...
<div class="tbl_frm01 tbl_wrap">
	...
	<tr>
		...
		<td><input type="text" name="seller_item" id="reg_seller_item" itemname="제공상품" class="frm_input" size="30" placeholder="예) 가전제품"></td>
	</tr>
	<tr>
		<th scope="row"><label for="reg_company_name">업체(법인)명</label></th>
		<td><input type="text" name="company_name" id="reg_company_name" itemname="업체(법인)명" class="frm_input" size="30"></td>
	</tr>
	<tr>
		<th scope="row"><label for="reg_company_owner">대표자명</label></th>
		<td><input type="text" name="company_owner" id="reg_company_owner" itemname="대표자명" class="frm_input" size="30"></td>
	</tr>
	<tr>
		<th scope="row"><label for="reg_company_saupja_no">사업자등록번호</label></th>
		<td><input type="text" name="company_saupja_no" id="reg_company_saupja_no" itemname="사업자등록번호" class="frm_input" size="30" placeholder="예) 206-23-12552"></td>
	</tr>
	<tr>
		<th scope="row"><label for="reg_company_item">업태</label></th>
		<td><input type="text" name="company_item" id="reg_company_item" itemname="업태" class="frm_input" size="30" placeholder="예) 서비스업"></td>
	</tr>
	<tr>
		<th scope="row"><label for="reg_company_service">종목</label></th>
		<td><input type="text" name="company_service" id="reg_company_service" itemname="종목" class="frm_input" size="30" placeholder="예) 전자상거래업"></td>
	</tr>
	<tr>
