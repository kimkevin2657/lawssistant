...
<!--[if IE]>
<script src="<?php echo MS_JS_URL; ?>/excanvas.js"></script>
<![endif]-->
<script src="<?php echo MS_JS_URL; ?>/jquery.signature.js"></script>
<script src="<?php echo MS_JS_URL; ?>/jquery.minishop_form.js"></script>
...
<div id="con_lf">
	<h2 class="pg_tit">
		...
		<h2 class="pg_title">
  <img src="/img/minishop_reg.jpg">
     <div class="inner">
	</h2>

	<form name="fminishopform" id="fminishopform" action="<?php echo $from_action_url; ?>" onsubmit="return fminishopform_submit(this);" method="post" autocomplete="off">
	<input type="hidden" name="token" value="<?php echo $token; ?>">

	<div class="fminishopform_term">
		<h2><?php echo $config['pf_stipulation_subj']; ?></h2>
		<textarea readonly><?php echo $config['pf_stipulation']; ?></textarea>
		<fieldset class="fminishopform_agree">
...
<script>
function fminishopform_submit(f) {
	errmsg = "";
	errfld = "";
