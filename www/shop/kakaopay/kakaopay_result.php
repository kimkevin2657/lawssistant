...
include_once(MS_SHOP_PATH.'/kakaopay/incKakaopayCommon.php');
include_once(MS_SHOP_PATH.'/kakaopay/lgcns_CNSpay.php');
...
$cardPoint = $connector->getResultData("CardPoint");		// 카드사쇼핑포인트사용여부 (0:미사용, 1:쇼핑포인트사용, 2:세이브쇼핑포인트사용)
