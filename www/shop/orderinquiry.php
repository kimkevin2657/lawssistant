...
if(MS_IS_MOBILE) {
	goto_url(MS_MSHOP_URL.'/orderinquiry.php');
}
...
if(!$is_member) {
    ...
    if($row['od_id']) {
        ...
        goto_url(MS_SHOP_URL.'/orderinquiryview.php?od_id='.$row['od_id'].'&uid='.$uid);
    }
}
...
Theme::get_theme_part(MS_THEME_PATH,'/orderinquiry.skin.php');
