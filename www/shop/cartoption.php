...
$sql_search = " ct_direct='{$member['id']}' and ct_select='0' and gs_id='$gs_id' ";
...
<!-- 장바구니 옵션 시작 { -->
<form name="foption" method="post" action="<?php echo MS_SHOP_URL; ?>/cartupdate.php" onsubmit="return formcheck(this);">
	...
	?>
		<li class="sit_<?php echo $cls; ?>_list vi_txt_li">
			<dl>
				...
				<dd class="op_vi_txt">
					<button type="button" class="defbtn_minus">-</button><input type="text" name="ct_qty[<?php echo $gs_id; ?>][]" value="<?php echo $row['ct_qty']; ?>" class="inp_opt" size="2"><button type="button" class="defbtn_plus">+</button>
