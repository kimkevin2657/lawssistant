<?php include_once('./_common.php');
    ...
    $g_home_dir   = __DIR__.'/';
    $g_cert_file  = __DIR__.'/cert/pg_cert.pem';
    $g_log_dir    = __DIR__."/log";
    $g_log_level  = "1";
    ...
    $r_stat_msg        = iconv_utf8($easyPay->_easypay_resdata[ "stat_msg"        ]);    //상태메시지
    ...
    $r_issuer_nm       = iconv_utf8($easyPay->_easypay_resdata[ "issuer_nm"       ]);    //발급사명
    $r_acquirer_cd     = $easyPay->_easypay_resdata[ "acquirer_cd"     ];    //매입사코드
    $r_acquirer_nm     = iconv_utf8($easyPay->_easypay_resdata[ "acquirer_nm"     ]);    //매입사명
    ...
    $r_cash_res_msg    = iconv_utf8($easyPay->_easypay_resdata[ "cash_res_msg"    ]);    //현금영수증 결과메세지
