...
<form name="frm" method="post"
    ...
    action="http://testpg.easypay.co.kr/webpay/MainAction.do" data-alt="테스트"
    <?php else : ?>
    action="https://pg.easypay.co.kr/webpay/MainAction.do" data-alt="운영"
    <?php endif; ?>
>
...
<iframe id="hiddenifr" name="hiddenifr" width="100%" height="500" frameborder="0" _src="./iframe_req.php" scrolling="0" _onload="resizeHeight(this)" />
</body>
</html>
