...
require_once(MS_SHOP_PATH.'/inicis/libs/HttpClient.php');
require_once(MS_SHOP_PATH.'/inicis/libs/json_lib.php');
...
try {
    ...
    if (strcmp('0000', $_REQUEST['resultCode']) == 0) {
        ...
        try {
			...
			$page_return_url  = MS_SHOP_URL.'/orderinicis.php?od_id='.$oid;
            ...
            if ((strcmp('0000', $resultMap['resultCode']) == 0) && (strcmp($secureSignature, $resultMap['authSignature']) == 0) ) { //결제보안 추가 2016-05-18
                ...
                require MS_SHOP_PATH.'/inicis/INIStdPayResult.php';
                exit;
            } else {
