...
if($od_settle_case == "계좌이체")
{
    switch($default['de_pg_service']) {
        case 'lg':
            ...
            break;
        case 'easypay':
            include MS_SHOP_PATH.'/easypay/easypay_result.php';
            break;
        case 'inicis':
            include MS_SHOP_PATH.'/inicis/inipay_result.php';
            break;
		case 'kcp':
    ...
    if((int)$i_price !== (int)$pg_price) {
        ...
        switch($od_pg) {
            case 'lg':
                ...
                break;
            case 'easypay':
                include MS_SHOP_PATH.'/easypay/easypay_cancel.php';
                break;
            case 'inicis':
