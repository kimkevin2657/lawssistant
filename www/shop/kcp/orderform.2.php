...
<!-- 복합 쇼핑포인트 결제시 넘어오는 쇼핑포인트사 코드 : OK캐쉬백(SCSK), 베네피아 복지쇼핑포인트(SCWB) -->
...
<!-- 복지쇼핑포인트 결제시 가맹점에 할당되어진 코드 값을 입력해야합니다.(필수 설정) -->
...
/* 신용카드 결제시 OK캐쉬백 적립 여부를 묻는 창을 설정하는 파라미터 입니다
	 OK캐쉬백 쇼핑포인트 가맹점의 경우에만 창이 보여집니다
...
/* 쇼핑포인트 결제시 복합 결제(신용카드+쇼핑포인트) 여부를 결정할 수 있습니다.- N 일경우 복합결제 사용안함
