...
$g_conf_home_dir  = MS_SHOP_PATH.'/kcp';
$g_conf_key_dir   = '';
$g_conf_log_dir   = '';
if(strtoupper(substr(PHP_OS, 0, 3)) === 'WIN')
{
    $g_conf_key_dir   = MS_SHOP_PATH.'/kcp/bin/pub.key';
    $g_conf_log_dir   = MS_SHOP_PATH.'/kcp/log';
}
...
include_once(MS_SHOP_PATH.'/kcp/pp_cli_hub_lib.php');
