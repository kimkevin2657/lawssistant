...
$EP_CASNOTEURL = MS_SHOP_URL.'/settle_easypay_common.php';
...
$EP_CERTTYPE= ['일반'=>'','인증'=>'21','비인증'=>'22'];

$EP_RETURNURL = "http://".$_SERVER['HTTP_HOST']."/shop/easypay/easypay_res.php";
$EP_NOTIURL   = "http://".$_SERVER['HTTP_HOST']."/shop/easypay/easypay_noti.php";
$EP_POPUPURL  = "http://".$_SERVER['HTTP_HOST']."/shop/easypay/popup_reg.php";
$EP_IFRAMEURL = "http://".$_SERVER['HTTP_HOST']."/shop/easypay/iframe_reg.php";
$EP_REQUESTURL= "http://".$_SERVER['HTTP_HOST']."/shop/easypay/request.php";
