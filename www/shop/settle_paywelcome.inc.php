...
if($default['de_card_test']) {
    if($default['de_escrow_use'] == 1) {
        ...
        // 일반결제 테스트
        $default['de_inicis_mid'] = 'welcometst';
        $default['de_inicis_admin_key'] = '1111';
        $default['de_inicis_sign_key'] = 'QjZXWDZDRmxYUXJPYnMvelEvSjJ5QT09';
    }

    $stdpay_js_url = 'https://tstdpay.paywelcome.co.kr/stdjs/INIStdPay.js';
}
else {
    if($default['de_escrow_use'] == 1) {
        // 에스크로결제
    ...
    $stdpay_js_url = 'https://stdpay.paywelcome.co.kr/stdjs/INIStdPay.js';
}

/**************************
 * 1. 라이브러리 인클루드 *
 **************************/
require(MS_SHOP_PATH.'/paywelcome/libs/INILib.php');
require_once(MS_SHOP_PATH.'/paywelcome/libs/INIStdPayUtil.php');
require_once(MS_SHOP_PATH.'/paywelcome/libs/sha256.inc.php');
...
$inipay->SetField("inipayhome", MS_SHOP_PATH.'/paywelcome'); // 이니페이 홈디렉터리(상점수정 필요)
...
/* 기타 */
$siteDomain = MS_SHOP_URL.'/paywelcome'; //가맹점 도메인 입력
