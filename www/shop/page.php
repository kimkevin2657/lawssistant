...
if(MS_IS_MOBILE) {
	goto_url(MS_MSHOP_URL.'/mypage.php');
}
...
if( isset($code ) ) {
    switch( $code ) {
        case 'minishop_info' :
        case 'mypage_minishop_info' :
            $pg_title = '기본정보 관리';
            $pg_sub   =  $pg_title;
            break;
        case 'minishop_orgchart' :
        case 'mypage_minishop_orgchart' :
            $pg_title = '조직도 회원조회';
            $pg_sub   =  $pg_title;
            break;
    }
...
?>
    <style>
        ...
        /*가맹점관련*/
        #minishop_list thead th{padding:6px 10px !important;}
        #minishop_list tfoot td{font-weight:600;background:#f1f1f1 !important;}
    ...
    <div id="con_lf">
        ...
        <h2 class="pg_tit">
            ...
            <p class="pg_nav">HOME<i>&gt;</i>마이페이지 <?php echo $pg_sub; ?></p>
        </h2>
        <div id="content">
<?php
$code_page = str_replace('mypage_', '', $code);
include_once( MS_PATH . '/'. MS_MYPAGE_DIR . "/{$code_page}.php");
?>     </div>
    </div>
<?php
