...
include_once(MS_SHOP_PATH.'/settle_paywelcome.inc.php');
 ...
 *
 *
 * http://www.paywelcome.com
 * http://support.paywelcome.com
 * Copyright (C) 2006 paywelcome, Co. All rights reserved.
 */
...
* 키패스워드는 상점관리자 페이지(https://iniweb.paywelcome.com)의 비밀번호가 아닙니다. 주의해 주시기 바랍니다.
...
if($inipay->GetResult('ResultCode') == '00') {
    ...
    if(!$result)
        include MS_SHOP_PATH.'/paywelcome/inipay_cancel.php';
}
...
{
    var showreceiptUrl = "https://iniweb.paywelcome.com/DefaultWebApp/mall/cr/cm/Cash_mCmReceipt.jsp?noTid=<?php echo($inipay->GetResult('TID')); ?>" + "&clpaymethod=22";
