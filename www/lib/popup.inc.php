...
$sql = " select * 
		   from shop_popup
		  where '".MS_TIME_YMD."' between begin_date and end_date
		    and device IN ( 'both', 'pc' )
            and state = '0' 
			and (mb_id = '$pt_id' or mb_id = 'admin')
...
?>
    <div id="hd_pops_<?php echo $nw['index_no']; ?>" class="hd_pops" style="top:<?php echo $nw['top']; ?>px;left:<?php echo $nw['lefts']; ?>px">
        ...
        <div class="hd_pops_footer">
            ...
            <!--button class="hd_pops_close hd_pops_<?php echo $nw['index_no']; ?>"><img src="img/btn/bt_close.png"></button-->
        </div>
    </div>
<?php }
