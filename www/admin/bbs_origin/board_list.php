...
include_once(MS_LIB_PATH.'/common.lib.php');

$sql_common = " from g5_board a ";
$sql_search = " where (1) ";

if ($is_admin != "super") {
    $sql_common .= " , g5_group b ";
    $sql_search .= " and (a.gr_id = b.gr_id and b.gr_admin = '{$member['id']}') ";
}
...
<div class="tbl_head01 tbl_wrap">
    ...
    for ($i=0; $row=sql_fetch_array($result); $i++) {
        ...
        $one_update = '<a href="./board_org_list.php?code=board_form&w=u&amp;bo_table='.$row['bo_table'].'&amp;'.$qstr.'" class="btn btn_03">수정</a>';
    ...
    <tr class="<?php echo $bg; ?>">
        ...
        <td>
            <?php if ($is_admin){ ?>
                <?php echo get_group_select2("gr_id[$i]", $row['gr_id']) ?>
            <?php }else{ ?>
        ...
        <td>
            ...
            <a href="<? echo MS_URL.'/bbs/board.php?bo_table='.$row['bo_table']; ?>"><?php echo $row['bo_table'] ?></a>
        </td>
        <!-- <td>
