...
<div class="tbl_frm02">
	...
	<tbody>
	<tr>
		<th scope="row">엑셀주문업로드</th>
		<td><a href="<?php echo MS_ADMIN_URL; ?>/order/upload_excel_order_ing_new.xls" class="btn_small bx-blue"><i class="fa fa-download"></i> 작성양식 다운로드</a></td>
	</tr>
	<tr>
...
<div class="btn_confirm">
	<input type="submit" value="주문업로드" class="btn_large">
</div>
</form>
...
function forderdelivery_submit(f)
{
	...
	if(!confirm("주문내역을 등록 하시겠습니까?"))
		return false;
	
	f.action = tb_admin_url+"/order.php?code=excel_ing_update";
	return true;
}
</script>
