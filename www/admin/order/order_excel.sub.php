...
$excel->setActiveSheetIndex(0)
	...
	->setCellValue($char++.'1', '주문취소일')
    ->setCellValue($char++.'1', '환불완료일')
...
for($i=2; $row=sql_fetch_array($result); $i++)
{
	...
	$excel->setActiveSheetIndex(0)
		...
		->setCellValueExplicit($char++.$i, $row['use_ppay'], PHPExcel_Cell_DataType::TYPE_NUMERIC)
