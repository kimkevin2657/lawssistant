...
// 주문서 query 공통
include_once(MS_ADMIN_PATH.'/order/order_query.php');
...
<div class="tbl_frm01">
	...
	<tr>
		...
		<td>
            ...
            <?php if( defined('USE_SHOPPING_PAY_BUY' ) && USE_SHOPPING_PAY_BUY ) echo radio_checked('od_settle_case', $od_settle_case, '쇼핑페이', '쇼핑페이'); ?>
		</td>
	</tr>
	<tr>
...
<div class="tbl_head01">
	...
	<tr class="<?php echo $bg; ?>">
		...
		<td rowspan="<?php echo $rowspan; ?>">
			<a href="<?php echo MS_ADMIN_URL; ?>/pop_orderform.php?od_id=<?php echo $row['od_id']; ?>" onclick="win_open(this,'pop_orderform','1200','800','yes');return false;"><?php echo $row['od_id']; ?></a>
			<?php echo $sodr['disp_mobile']; ?>
			<?if($row['exchange_status']=="Y"){?>
				<br /><font color="red">교환 처리완료</font>
			<?}else{?>
				<br /><font color="blue">교환 처리중</font>
			<?}?>
		</td>
		<td rowspan="<?php echo $rowspan; ?>">
