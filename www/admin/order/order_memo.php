...
<div class="tbl_head01">
	...
	<tr class="<?php echo $bg; ?>">
		...
		<td><a href="<?php echo MS_ADMIN_URL; ?>/pop_orderform.php?od_id=<?php echo $row['od_id']; ?>" onclick="win_open(this,'pop_orderform','1200','800','yes');return false;" class="fc_197"><?php echo $row['od_id']; ?></a></td>
