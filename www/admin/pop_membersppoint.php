...
if($fr_date && $to_date)
    $sql_search .= " and sp_datetime between '$fr_date 00:00:00' and '$to_date 23:59:59' ";
else if($fr_date && !$to_date)
	$sql_search .= " and sp_datetime between '$fr_date 00:00:00' and '$fr_date 23:59:59' ";
else if(!$fr_date && $to_date)
	$sql_search .= " and sp_datetime between '$to_date 00:00:00' and '$to_date 23:59:59' ";

$sql_order = " order by sp_id desc ";
...
$row2 = sql_fetch("select sum(sp_price) as sum_point $sql_common $sql_search ");
...
<div id="memberpoint_pop" class="new_win">
	...
	<div class="tbl_head01">
		...
		<tr>
			<th scope="col">번호</th>
			<th scope="col">쇼핑페이내용</th>
			<th scope="col">일시</th>
			<th scope="col">쇼핑페이</th>
			<th scope="col">쇼핑페이합</th>
		</tr>
		</thead>
		<?php
		...
		<tr class="<?php echo $bg; ?>">
			...
			<td class="tar"><?php echo number_format($row['sp_mb_price']); ?></td>
		</tr>
		<?php 
		}
		if($i==0)
