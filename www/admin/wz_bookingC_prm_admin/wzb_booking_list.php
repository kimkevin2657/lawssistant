...
<div>
    ...
    <select name="sfl" id="sfl">
        ...
        <option value="store_mb_id" <?php echo ($sfl == "store_mb_id" ? "selected=selected" : "");?>>매장아이디</option>
        <option value="bk_subject" <?php echo ($sfl == "bk_subject" ? "selected=selected" : "");?>>디자이너명</option>
...
<form name="frmlist" action="./wzb_booking_list_update.php?<?php echo $qstr;?>" method="post" onsubmit="return frm_submit(this);">
    ...
    if ($cnt_order > 0) {
        for ($z = 0; $z < $cnt_order; $z++) {
            ...
            <tr class="<?php echo $bg; ?>">
                ...
                <td><?php echo $arr_order[$z]['store_mb_id'];?></td>
                <td>
                    <?php
                    if ($cnt_room) {
...
function getSearch(f) {
    f.action = "./wzb_booking_list2.php";
}
function getExcel(f) {
