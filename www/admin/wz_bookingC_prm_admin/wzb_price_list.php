...
<div class="tbl_head01 tbl_wrap">
    ...
    <?php if ($sch_rm_ix) {?>
        ...
        <div class="cal_navi">
            <a href="javascript:getCalender('<?php echo $year_prev?>','<?php echo $month_prev?>','<?php echo $sch_day?>');"><img src="./wz_bookingC_prm_admin/img/prev_chevron.png" /></a>&nbsp;
            <span class="title_red"><?php echo $sch_year?>년 <span><?php echo $sch_month_02d?>월</span>&nbsp;
            <a href="javascript:getCalender('<?php echo $year_next?>','<?php echo $month_next?>','<?php echo $sch_day?>');"><img src="./wz_bookingC_prm_admin/img/next_chevron.png" /></a>       
        </div>
        ...
        <!--
            function getCalender(sch_year, sch_month, sch_day) { 
                location.href = "<?php echo $_SERVER['SCRIPT_NAME']?>?sch_cp_ix=<?php echo $sch_cp_ix?>&sch_rm_ix=<?php echo $sch_rm_ix?>&sch_year="+sch_year+"&sch_month="+sch_month+"&sch_day="+sch_day;
            }
