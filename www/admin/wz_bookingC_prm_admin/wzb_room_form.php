...
$store2 = sql_fetch("SELECT * FROM shop_member where id = '{$rm['store_mb_id']}' ");
?>
...
<form name="frm" id="frm" action="./wzb_room_form_update.php" method="post" onsubmit="return getAction(this);" autocomplete="off" enctype="multipart/form-data">
...
<input type="hidden" name="rm_level" value="1">
            ...
            <tr>
                ...
                <td>
                    ...
                    <!-- <select name="store_mb_id">
                        <?
                            $sql = sql_query("SELECT * FROM shop_member where grade IN (2, 5) ");
    ...
    <div class="btn_confirm01 btn_confirm">
        ...
        <a href="./wzb_booking_list2.php?code=wzb_room_list<?php echo $qstr; ?>">목록</a>
    </div>
