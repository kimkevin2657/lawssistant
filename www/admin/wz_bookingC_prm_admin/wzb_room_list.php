...
if ($sch_subject) {
    $sql_search .= " and ( rm_subject like '%".$sch_subject."%' or store_mb_id like '%".$sch_subject."%' or rm_subject like '%".$sch_subject."%' ) ";
...
<div class="sch_last">
    ...
    <input type="text" id="sch_subject" name="sch_subject" value="<?php echo $sch_subject;?>" class="frm_input" size="20" maxlength="20" placeholder="매장아이디, 이용서비스, 디자이너명 검색" style="width:220px;">
...
<div class="btn_add01 btn_add">
    <a href="./wzb_room_form.php?<?php echo $qstr;?>" id="bo_add">이용정보 추가</a>
</div>
...
<div class="tbl_head01 tbl_wrap">
    ...
    <tr>
        ...
        <th width="auto" scope="col">매장아이디</th>
    ...
    <tr class="<?php echo $bg; ?>">
        ...
        <td><?php echo $arr_room[$z]['store_mb_id']; ?></td>
        ...
        <td class="td_mngsmall">
            <a href="./wzb_room_form.php?code=wzb_room_list&w=u&amp;rm_ix=<?php echo $arr_room[$z]['rm_ix']; ?>&amp;<?php echo $qstr; ?>">수정</a>&nbsp;
            <a href="./wzb_room_form_update.php?w=d&amp;rm_ix=<?php echo $arr_room[$z]['rm_ix']; ?>&amp;<?php echo $qstr; ?>" onclick="return delete_confirm(this);">삭제</a> 
        </td>
    </tr>
