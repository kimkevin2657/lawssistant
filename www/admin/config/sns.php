...
<div class="tbl_frm01">
	...
	<tr>
		...
		<td><input type="text" name="de_kakao_secret" value="<?php echo $default['de_kakao_secret']; ?>" class="frm_input" size="50"></td>
	</tr>
    <tr>
		<th scope="row">구글 Client ID</th>
		<td>
			<input type="text" name="de_googl_appid" value="<?php echo $default['de_googl_appid']; ?>" class="frm_input" size="50">
			<a href="https://console.developers.google.com/" target="_blank" class="btn_small grey">앱 등록하기</a>
			<?php echo help('앱설정시 Callback URL에 http://도메인주소/plugin/login-oauth/login_with_google.php 입력'); ?>
		</td>
	</tr>
	<tr>
		<th scope="row">구글 Client Secret</th>
		<td><input type="text" name="de_googl_secret" value="<?php echo $default['de_googl_secret']; ?>" class="frm_input" size="50"></td>
	</tr>
	</tbody>
	</table>
</div>
