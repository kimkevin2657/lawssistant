...
<div class="tbl_frm01">
	...
	<tr>
		<th scope="row">추천인 쇼핑포인트</th>
		<td>
			<input type="text" name="minishop_point" value="<?php echo number_format($config['minishop_point']); ?>" class="frm_input w80" onkeyup="addComma(this);"> 원
		</td>
	</tr>
	<tr>
