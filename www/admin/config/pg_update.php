...
$value['de_easypay_mid']						= $_POST['de_easypay_mid']; // EASYPAY ID
...
$value['de_paywelcome_mid']						= $_POST['de_paywelcome_mid']; // 페이웰컴 상점아이디
$value['de_paywelcome_admin_key']				= $_POST['de_paywelcome_admin_key']; // 페이웰컴 키패스워드
$value['de_paywelcome_sign_key']				= $_POST['de_paywelcome_sign_key']; // 페이웰컴 웹결제 사인키
$value['de_paywelcome_samsung_pay_use']			= $_POST['de_paywelcome_samsung_pay_use']; // 페이웰컴 삼성페이 버튼
update("shop_default", $value);

goto_url(MS_ADMIN_URL.'/config.php?code=pg');
?>
