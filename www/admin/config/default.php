...
<div class="tbl_frm01">
	...
	<tr>
		...
		<td>
			...
			<?php
			$file = MS_DATA_PATH.'/common/'.$config['admin_seal'];
			if(is_file($file) && $config['admin_seal']) {
				$seal = rpc($file, MS_PATH, MS_URL);
			?>
...
<div class="tbl_frm01">
	...
	<tr>
		...
		<td>
			<label><input type="checkbox" name='cert_minishop_yes' value="1"<?php echo $config['cert_minishop_yes']?" checked":""; ?>> 가맹점도 인증권한 부여 <span class="fc_197">(각 가맹점에 소속 된 회원일경우 직접 인증할 수 있습니다)</span></label>
		</td>
	</tr>
	</tbody>
	</table>
...
<div class="tbl_frm01">
	...
	<tr>
		...
		<td>
            <input type="text" name="basic_goods_kv" value="<?php echo number_format($config['basic_goods_kv']); ?>" class="frm_input w80" onkeyup="addComma(this);"> 원
			<input type="text" name="basic_goods_kv_per" class="frm_input w50" value="<?php echo number_format($config['basic_goods_kv_per']); ?>"> %
	...
	<tr>
		...
		<td>
			<input type="text" name="basic_gpoint" value="<?php echo number_format($config['basic_gpoint']); ?>" class="frm_input w80" onkeyup="addComma(this);"> P
			<input type="text" name="basic_gpoint_per" class="frm_input w50" value="<?php echo number_format($config['basic_gpoint_per']); ?>"> %
...
<div class="tbl_frm01">
	...
	<tr>
		<th scope="row">배송중 자동 배송완료</th>
		<td><input type="text" name="de_bae_keep_term" value="<?php echo $default['de_bae_keep_term']; ?>" class="frm_input w50"> 일 이후 자동 배송완료</td>
		<th scope="row">&nbsp;</th>
		<td>&nbsp;</td>
	</tr>
	</tbody>
	...
	<tr>
		...
		<td class="td_label">
			...
			<p class="clear_fld mart7 dn">
				...
				<label><input type="checkbox" name="clear_5" value="1"> 회원쇼핑포인트</label>
