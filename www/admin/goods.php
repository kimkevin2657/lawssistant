...
if($code == "list_supply")						 $pg_title2 = ADMIN_MENU5_01;
...
if($code == "excel_ing")						 $pg_title2 = ADMIN_MENU5_24;
if($code == "excel_ing_update")					 $pg_title2 = ADMIN_MENU5_24;
if($code == "naver_list")						 $pg_title2 = ADMIN_MENU5_25;
if($code == "naver_list_auto")					 $pg_title2 = ADMIN_MENU5_26;
if($code == "cate")								 $pg_title2 = ADMIN_MENU5_27;
...
<div class="s_wrap">
	...
	<?php
	include_once(MS_ADMIN_PATH."/goods/goods_{$code}.php");
	?>
</div>
