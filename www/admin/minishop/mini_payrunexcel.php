...
$sql_search = " where a.mb_id = b.id and b.id = c.mb_id and a.state = '0' ";
...
$sql = " select a.*, c.company_name, c.company_saupja_no, c.company_type, b.name, b.grade, b.term_date, b.pay $sql_common $sql_search $sql_order ";
