...
$sql_common = " from shop_minishop_payrun a, shop_member b, shop_minishop c  ";
$sql_search = " where a.mb_id = b.id and a.mb_id = c.mb_id and a.state = '0' ";
...
$sql = " select a.*, c.company_type, c.company_name, c.company_saupja_no, b.name, b.grade, b.term_date, b.pay
			$sql_common 
			$sql_search 
			$sql_order 
...
<a href="./minishop/mini_payrunexcel.php?$q1" class="btn_lsmall bx-white"><i class="fa fa-file-excel-o"></i> 엑셀저장</a>
EOF;
...
<form name="fpayrun" id="fpayrun" method="post" action="./minishop/mini_payrunupdate.php" onsubmit="return fpayrun_submit(this);">
...
<div class="tbl_head01">
	...
	<tr>
        ...
        <th scope="col"><?php echo subject_sort_link('c.company_name', $q2); ?>회사명</a></th>
        <th scope="col"><?php echo subject_sort_link('c.company_saupja_no', $q2); ?>사업자번호</a></th>
