...
$sql_common = " from shop_minishop_pay a, shop_member b, shop_minishop c ";
$sql_search = " where a.mb_id = b.id and b.id = c.mb_id ";
...
if( isset($ssz) && !empty($ssz) ) {
    $sql_search .= " and c.from_biz_type = '{$ssz}'";
}
if(!$orderby) {
    $filed = "a.pp_id";
    $sod = "desc";
...
<a href="./minishop/mini_payhistoryexcel.php?$q1" class="btn_lsmall bx-white"><i class="fa fa-file-excel-o"></i> 엑셀저장</a>
EOF;
?>
...
<div class="tbl_frm01">
    ...
    <tr>
        <th scope="row">비즈유형검색</th>
        <td>
            <?php echo get_search_biz_type('ssz', $ssz); ?>
        </td>
    </tr
	</tbody>
	</table>
...
<form name="fpayhistory" id="fpayhistory" method="post" action="./minishop/mini_payhistorydelete.php" onsubmit="return fpayhistory_submit(this);">
...
<div class="tbl_head01">
	...
	<tr>
        ...
        <th scope="col"><?php echo subject_sort_link('a.pp_due_date', $q2); ?>정산가능일</a></th>
	...
	<tr class="<?php echo $bg; ?>">
        ...
        <td><?php echo $row['pp_due_date']; ?></td>
