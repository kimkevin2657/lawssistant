...
$sql_common = " from shop_minishop_shopping_payrun a, shop_member b ";
...
<a href="./minishop/mini_sprunexcel.php?$q1" class="btn_lsmall bx-white"><i class="fa fa-file-excel-o"></i> 엑셀저장</a>
EOF;
...
<form name="fpayrun" id="fpayrun" method="post" action="./minishop/mini_sprunupdate.php" onsubmit="return fpayrun_submit(this);">
<input type="hidden" name="q1" value="<?php echo $q1; ?>">
<input type="hidden" name="page" value="<?php echo $page; ?>">

<div class="local_ov mart30">
	전체 : <b class="fc_red"><?php echo number_format($total_count); ?></b> 건 조회
	<strong class="ov_a">총 환전요청P <?php echo number_format($stotal_pay); ?>P </strong>
</div>
...
<div class="tbl_head01">
	...
	<tr>
		...
		<th scope="col" class="th_bg"><?php echo subject_sort_link('a.balance',$q2); ?>출금요청P</a></th>
		<th scope="col" class="th_bg"><?php echo subject_sort_link('a.paytax',$q2); ?>세액공제(수수료)P</a></th>
		<th scope="col" class="th_bg"><?php echo subject_sort_link('a.paynet',$q2); ?>실수령액P</a></th>
