...
$sql_common = " from shop_minishop_term a, shop_member b ";
...
<form name="ftermlist" id="ftermlist" method="post" action="./minishop/mini_termlistupdate.php" onsubmit="return ftermlist_submit(this);">
