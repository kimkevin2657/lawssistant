	...
	<tr>
		...
		<td>
			<select name="sfl">
                ...
                <?php echo option_selected('a.po_content', $sfl, '쇼핑포인트내용'); ?>
			</select>
...
<form name="fpointlist" id="fpointlist" method="post" action="./minishop/mini_point_delete.php" onsubmit="return fpointlist_submit(this);">
<input type="hidden" name="q1" value="<?php echo $q1; ?>">
<input type="hidden" name="page" value="<?php echo $page; ?>">

<div class="local_ov mart30">
	전체 : <b class="fc_red"><?php echo number_format($total_count); ?></b> 건 조회	
	<strong class="ov_a">쇼핑포인트 합계 : <?php echo number_format($sum_point); ?>원</strong>
</div>
...
<div class="tbl_head01">
	...
	<colgroup>
		...
		<col>
		<col class="w130">			
		<col class="w100" $sql_search .= " and $sfl like '%$stx%' "; $sql_search .= " and $sfl like '%$stx%' ";>
		<col class="w100">
	</colgroup>
	<thead>
	<tr>
		...
		<th scope="col"><?php echo subject_sort_link('a.po_content', $q2); ?>쇼핑포인트내용</a></th>
		<th scope="col"><?php echo subject_sort_link('a.po_datetime', $q2); ?>일시</a></th>
		<th scope="col"><?php echo subject_sort_link('a.po_point', $q2); ?>쇼핑포인트</a></th>
		<th scope="col">쇼핑포인트합</th>
	</tr>
	</thead>
	<?php
...
<div class="information">
	...
	<div class="content">
		<div class="desc02">
			<p>ㆍ쇼핑포인트가 음수인 내역을 삭제할 경우 쇼핑포인트가 다시 복원처리됩니다.</p>
			<p>ㆍ쇼핑포인트가 양수인 내역을 삭제할 경우 쇼핑포인트가 다시 차감처리됩니다.</p>
		</div>
	</div>
</div>
