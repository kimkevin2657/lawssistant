...
<div class="local_ov mart30">
	...
	<strong class="ov_a">총 마일리지잔액 : <?php echo number_format($stotal_pay); ?>원 </strong>
</div>
<div class="local_frm01">
	...
	<?php } ?>
	<a href="./minishop/mini_paylistexcel.php?<?php echo $q1; ?>" class="btn_small bx-white"><i class="fa fa-file-excel-o"></i> 엑셀저장</a>
</div>
...
<div class="tbl_head02">
	...
	<tr>
		...
		<th scope="col" colspan="3">누적 마일리지집계</th>
		<th scope="col" colspan="5">유형별 마일리지집계</th>
	</tr>
	<tr class="rows">
		...
		<th scope="col" class="th_bg">후원</th>
        <?php if( defined('USE_ANEWMATCH') && USE_ANEWMATCH ) { ?><th scope="col" class="th_bg">매칭</th> <?php } ?>
	...
	<tr class="<?php echo $bg; ?>">
        ...
        <?php if( defined('USE_ANEWMATCH') && USE_ANEWMATCH ) {  ?><td class="tar"><?php echo number_format($anew_match['pay']); ?></td><?php } ?>
...
<h2>마일리지 개별 적립</h2>
<form name="fpaylist2" id="fpaylist2" method="post" action="./minishop/mini_ppayupdate.php" autocomplete="off">
<input type="hidden" name="q1" value="<?php echo $q1; ?>">
<input type="hidden" name="page" value="<?php echo $page; ?>">
...
<div class="tbl_frm01">
	...
	<tr>
		<th scope="row"><label for="pp_content">마일리지 내용</label></th>
		<td><input type="text" name="pp_content" id="pp_content" required class="required frm_input" size="60"></td>
	</tr>
	<tr>
		<th scope="row"><label for="pp_pay">마일리지</label></th>
		<td><input type="text" name="pp_pay" id="pp_pay" required class="required frm_input" size="10"> 원</td>
	</tr>
	<tr>
		<th scope="row"><label for="pp_pay">추천인 지급여부</label></th>
		<td><label><input type="checkbox" name="pp_minishop" id="pp_minishop" value="Y" > 추천인에게 단계별로 지급을 원하는 경우 체크하세요.</label></td>
	</tr>
	</tbody>
	</table>
</div>
...
<div class="btn_confirm">
	<input type="submit" value="마일리지 지급" class="btn_large red">
</div>
</form>
...
<div class="information">
	...
	<div class="content">
		<div class="desc02">
			<p>ㆍ마일리지를 적립할 경우 양수만 입력하시기 바랍니다. 예) 3000</p>
			<p>ㆍ마일리지를 차감할 경우 음수도 포함해 입력하시기 바랍니다. 예) -3000</p>
			<p class="fc_red">ㆍ마일리지 차감액이 현재 잔액보다 클경우 차감되지 않습니다.</p>
		</div>
	</div>
</div>
