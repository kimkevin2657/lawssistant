...
for($i=2; $row=sql_fetch_array($result); $i++)
{
	...
	$excel->setActiveSheetIndex(0)
		...
		->setCellValueExplicit($char++.$i, $row['lp_content'], PHPExcel_Cell_DataType::TYPE_STRING)
		->setCellValueExplicit($char++.$i, $row['lp_datetime'], PHPExcel_Cell_DataType::TYPE_STRING)
		->setCellValueExplicit($char++.$i, $gw_ptype[$row['lp_rel_table']], PHPExcel_Cell_DataType::TYPE_STRING)
		->setCellValueExplicit($char++.$i, $row['lp_point'], PHPExcel_Cell_DataType::TYPE_NUMERIC)
		->setCellValueExplicit($char++.$i, $row['lp_balance'], PHPExcel_Cell_DataType::TYPE_NUMERIC);
}
