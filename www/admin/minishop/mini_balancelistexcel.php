...
for($i=2; $row=sql_fetch_array($result); $i++)
{
	...
	$pt = get_minishop($row['mb_id'], 'bank_name, bank_account, bank_holder');
	...
	$excel->setActiveSheetIndex(0)
        ...
        ->setCellValueExplicit($char++.$i, $pay_bank_fee, PHPExcel_Cell_DataType::TYPE_NUMERIC)
