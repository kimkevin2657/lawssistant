...
$sql_common = " from shop_minishop a inner join shop_member b on a.mb_id = b.id left join shop_minishop_center c on b.pc_no = c.pc_no ";
$sql_search = " where 1 ";

if($sfl && $stx) {
    if( $sfl == 'a.mb_id' || $sfl == 'b.pt_id') $sql_search .= " and $sfl like '%".$stx."%' ";
...
$sql = " select a.*, b.pt_id, b.name, b.anew_date, c.pc_nm
			$sql_common 
			$sql_search 
			$sql_order 
	...
	<tr>
		...
		<td>
			<select name="sfl">
                ...
                <?php echo option_selected('a.from_biz_name', $sfl, '타법인명'); ?>
...
<form name="fanewlist" id="fanewlist" method="post" action="./minishop/mini_anewlistupdate.php" onsubmit="return fanewlist_submit(this);">
...
<div class="tbl_head01">
	...
	<tr>
        ...
        <th scope="col"><?php echo subject_sort_link('c.pc_nm',$q2); ?>센터명</a></th>
        <th scope="col"><?php echo subject_sort_link('a.from_biz_name',$q2); ?>타법인명</a></th>
	...
	<tr class="<?php echo $bg; ?>">
        ...
        <td class="tal"><?php echo $row['pc_nm']; ?></td>
        <td class="tal"><?php echo $row['from_biz_name']; ?></td>
