...
<div class="tbl_frm02">
	...
	<tr>
		<th scope="row">레벨</th>
		<td>
			<?php echo get_member_select("mb_grade", $bn['mb_grade']); ?>
			<select name="category_name" id="category_name">
				...
				?>
				<option value="<? echo $row['category_name']; ?>" <? echo $row['category_name'] == $bn['category_name'] ? "selected":""; ?> ><? echo $row['category_name']; ?></option>
				<? } ?>
			</select>
		</td>
	</tr>
