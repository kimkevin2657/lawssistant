...
$sql_common = " from shop_member a left join shop_minishop_center b on a.pc_no = b.pc_no";
...
$sql = " select a.*, b.pc_nm $sql_common $sql_search $sql_order  ";
...
{	
	...
	$excel->setActiveSheetIndex(0)
        ...
        ->setCellValueExplicit($char++.$i, $row['pc_nm'], PHPExcel_Cell_DataType::TYPE_STRING)
		->setCellValueExplicit($char++.$i, $row['pt_id'], PHPExcel_Cell_DataType::TYPE_STRING)
        ->setCellValueExplicit($char++.$i, $row['up_id'], PHPExcel_Cell_DataType::TYPE_STRING)
