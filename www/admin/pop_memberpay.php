...
$sql_common = " from shop_minishop_pay ";
$sql_search = " where mb_id = '$mb_id' ";

if($fr_date && $to_date)
    $sql_search .= " and pp_datetime between '$fr_date 00:00:00' and '$to_date 23:59:59' ";
else if($fr_date && !$to_date)
	$sql_search .= " and pp_datetime between '$fr_date 00:00:00' and '$fr_date 23:59:59' ";
else if(!$fr_date && $to_date)
	$sql_search .= " and pp_datetime between '$to_date 00:00:00' and '$to_date 23:59:59' ";
...
$row2 = sql_fetch("select sum(pp_pay) as sum_point $sql_common $sql_search ");
...
<div id="memberpoint_pop" class="new_win">
	...
	<div class="local_ov mart30">
		...
		<strong class="ov_a">가맹점수수료 합계 : <?php echo number_format($sum_point); ?>원</strong>
	</div>
	...
	<div class="tbl_head01">
		...
		<tr>
			<th scope="col">번호</th>
			<th scope="col">가맹점수수료내용</th>
			<th scope="col">일시</th>
			<th scope="col">가맹점수수료</th>
			<th scope="col">가맹점수수료합</th>
		</tr>
		</thead>
		<?php
