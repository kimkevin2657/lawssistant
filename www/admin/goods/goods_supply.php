...
$sql_search = " where a.mb_id in ( select seller_code from shop_seller where state = 1 ) and a.shop_state != '0' ";
...
<div class="tbl_head02">
	...
	<tr>
		...
		<th scope="col" rowspan="2"><?php echo subject_sort_link('a.shop_state',$q2); ?>상태</a></th>
	...
	<tr class="<?php echo $bg; ?>">
		...
		<td rowspan="2"><?php echo $gw_state[$row['shop_state']]; ?></td>
