...
<div class="s_wrap">
	...
	<div class="tbl_head01">
		...
		<tr>
			...
			<th><?php echo subject_sort_link('a.goods_price',$q2); ?>판매가</a></th>
			<th>관리</th>
		</tr>
		</thead>
		<?php
		...
		<tr class="<?php echo $bg; ?>">
			...
			<td><a href="<?php echo MS_SHOP_URL; ?>/view.php?index_no=<?php echo $gs_id; ?>" target="_blank"><?php echo get_it_image($gs_id, $row['simg1'], 40, 40); ?></a></td>
			<td><?php echo $row['gcode']; ?></td>
			<td><?php echo ($row['mb_id']==encrypted_admin())?"매입":"위탁"; ?></td>
...
function chk_save(gs_id, gs_name, gs_img, gs_price){
	...
	if(ck_use_goods_info.indexOf(this_good)==-1){
		...
		str += "<a href=\"javascript:chk_del('"+gs_id+"');\" class=\"bt_del\"><img src=\"<?php echo MS_ADMIN_URL; ?>/img/bt_delete.gif\"></a>";
		str += "</li>";
