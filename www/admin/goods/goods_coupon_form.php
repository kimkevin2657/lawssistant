	...
	if($coupon['cp_use_goods']) {
		...
		foreach($arr_use_goods as $gs_id){
			...
			if($gs['index_no']) {
				...
				$ck_use_goods .= "<a href=\"".MS_SHOP_URL."/view.php?index_no={$gs_id}\" target=\"_blank\"><img src=\"{$gs_img}\" class=\"pr_img\"></a>";
				$ck_use_goods .= "<p>{$gs_name}</p><p class=\"mart5 bold\">{$gs_price}원</p>";
				$ck_use_goods .= "<a href=\"javascript:chk_del('{$gs_id}');\" class=\"bt_del\"><img src=\"".MS_ADMIN_URL."/img/bt_delete.gif\"></a>";
				$ck_use_goods .= "</li>";
...
<div class="tbl_head01">
    ...
    <tr class="<?php echo ($coupon['cp_type']=='6')?'list1':'list0'; ?>">
        <td class="tal">
            <label><input type="radio" name="cp_type" value="6"<?php echo ($coupon['cp_type']=='6')?' checked':''; ?> onclick="chk_show('6');"> <b>수동 발급</b></label>
            <span class="vam fc_197">(Ex : 관리자가 수동으로 발급합니다.)</span>
        </td>
        <td>최대 <input type="text" name="cp_dlimit6" value="<?php echo $arr_dlimit[6]; ?>" class="frm_input w80"> 건 <a href="javascript:chk_obj('cp_dlimit6', '99999999999');" class="btn_small grey">무제한</a></td>
        <td>
            <?php echo get_goods_level_select('cp_dlevel6', $arr_dlevel[6]); ?>
        </td>
        <td>자유</td>
    </tr>
	</tbody>
...
<div class="tbl_frm01">
	...
	<tr id="ids_download">
		...
		<td>
            ...
            <p class="mart3">
                <label><input type="radio" name="cp_download" value="3"<?php echo ($coupon['cp_download']=='3')?' checked':''; ?>> 수동 발급</label>
                <span class="fc_197 marl5">(자동 발급 되지 않습니다.)</span>
            </p>
		</td>
	</tr>
	<tr>
	...
	<div class="tbl_frm01">
		...
		<tr id="ids_age">
			...
			<td>
				...
				<span class="fc_197 marl5">생년월일 앞 4자리만 입력 (Ex : <?php echo MS_TIME_YEAR-5; ?>년생부터 <?php echo MS_TIME_YEAR; ?>년생까지)</span>
			</td>
		</tr>
		<tr id="ids_day">
		...
		<tr id="ids_gpart">
			...
			<td>
				...
				<p>
					...
					<a href="<?php echo MS_ADMIN_URL; ?>/goods/goods_coupon_goods.php" onclick="win_open(this,'cp_goods','850','800','yes'); return false;" class="btn_small red marl10">상품등록</a>
				</p>
