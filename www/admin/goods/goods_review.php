...
<div class="tbl_head01">
	...
	<tr class="<?php echo $bg; ?>">
      ...
      <input type="hidden" name="od_id[<?php echo $i; ?>]" value="<?php echo $row['od_id']; ?>">
		...
		<td class="tal">
      <a href="<?php echo MS_SHOP_URL; ?>/view.php?index_no=<?php echo $row['gs_id']; ?>" target="_blank"><b><?php echo get_text($gs['gname']); ?></b></a>
      <p class="mart5 fc_137"><?php echo get_text($row['memo']); ?></p>
      <?php if($row['photo_file_1']) { ?>
      <br/>
      <a href="<?=$row['photo_file_1']?>" data-lightbox="image-<?=$i?>" data-title=""><img src="<?=$row['photo_file_1']?>" style="width:50px;height:50px;border:1px solid"></a>
      <?php } ?>
      <?php if($row['photo_file_2']) { ?>
      <a href="<?=$row['photo_file_2']?>" data-lightbox="image-<?=$i?>" data-title=""><img src="<?=$row['photo_file_2']?>" style="width:50px;height:50px;border:1px solid"></a>
      <?php } ?>
      <?php if($row['photo_file_3']) { ?>
      <a href="<?=$row['photo_file_3']?>" data-lightbox="image-<?=$i?>" data-title=""><img src="<?=$row['photo_file_3']?>" style="width:50px;height:50px;border:1px solid"></a>
      <?php } ?>
    </td>
		<td><?php echo $row['seller_id']; ?></td>
		<td><?php echo cut_str(get_member_name($row['mb_id']), 12); ?></td>
