...
$value['br_updatetime'] = MS_TIME_YMDHIS;
$value['sho_go'] = $_POST['sho_go'];


if($w == '') {
	$value['mb_id'] = 'admin';
	$value['br_time'] = MS_TIME_YMDHIS;
	...
	goto_url(MS_ADMIN_URL."/goods.php?code=brand_form&w=u&br_id=$br_id$qstr&page=$page");
}
?>