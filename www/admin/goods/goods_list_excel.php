...
$excel->setActiveSheetIndex(0)
	...
	->setCellValue($char++.'1', '상품코드 자동')
	->setCellValue($char++.'1', '상품코드 수동')
...
for($i=2; $row=sql_fetch_array($result); $i++)
{
	...
	->setCellValueExplicit($char++.$i, $row['gcode_r'], PHPExcel_Cell_DataType::TYPE_STRING)
	...
	->setCellValueExplicit($char++.$i, $row['isnaver'], PHPExcel_Cell_DataType::TYPE_NUMERIC)
	...
	->setCellValueExplicit($char++.$i, $row['sc_each_use'], PHPExcel_Cell_DataType::TYPE_NUMERIC)
	...
	->setCellValueExplicit($char++.$i, $row['naver_price_url'], PHPExcel_Cell_DataType::TYPE_STRING);
}
