...
//    error_reporting(E_ALL ^ E_NOTICE);
	...
	{		
        ...
        $minus = "";
		if($io_price<0) $minus = "-";
        $io_price		= addslashes(conv_number(trim($io_price))); // 옵션가격
		$io_price = $minus.$io_price;
...
<div class="btn_confirm">
	<a href="<?php echo MS_ADMIN_URL; ?>/goods.php?code=xls_option_reg" class="btn_large">확인</a>
</div>
