...
<div class="tbl_head01">
	...
	<tr class="<?php echo $bg; ?>">
		...
		<td class="tar"><?php echo number_format($row['tot_minishop']); ?></td>
		<td class="tar fc_red bold"><?php echo number_format($row['tot_admin']); ?></td>
		<td><a href="<?php echo MS_ADMIN_URL; ?>/pop_sellerorder.php?mb_id=<?php echo $row['mb_id']; ?>&order_idx=<?php echo $row['order_idx']; ?>" onclick="win_open(this,'pop_sellerorder','1200','600','yes');return false;" class="btn_small">내역</a></td>
	</tr>
	<?php
	}
	if($i==0)
