...
//    error_reporting(E_ALL ^ E_NOTICE);
	...
	for($i=4; $i<=$data->sheets[0]['numRows']; $i++) 
	{
		...
		$mb_plain_id = addslashes(trim(strtolower($data->sheets[0]['cells'][$i][$j++]))); //아이디
        $mb_id  = $mb_plain_id;
		...
		$mfrm['pt_id'] = encrypted_admin(); //추천인
...
<div class="btn_confirm">
	<a href="<?php echo MS_ADMIN_URL; ?>/seller.php?code=xls" class="btn_large">확인</a>
</div>
