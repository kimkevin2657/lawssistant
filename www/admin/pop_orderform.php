	...
	<section id="anc_sodr_list">
		...
		<div class="local_desc02 local_desc">
			<p>
				...
				<a href="javascript:win_open('<?php echo MS_ADMIN_URL; ?>/order/order_print.php?od_id=<?php echo $od_id; ?>','order_print','670','600','yes');" class="btn_small blue fr"><i class="fa fa-print"></i> 주문서출력</a>
			</p>
		</div>
		...
		<div class="tbl_head01">
			...
			<tr>
                ...
                <!--<th scope="col">쇼핑페이결제</th>
                <th scope="col">마일리지결제</th>-->
			...
			<tr class="<?php echo $bg; ?>">
				...
				<td class="tal">
					<a href="<?php echo MS_ADMIN_URL; ?>/goods.php?code=form&w=u&gs_id=<?php echo $row['gs_id']; ?>" target="_blank"><?php echo get_text($gs['gname']); ?></a><br/>
          상품코드 : <?=$gs['gcode']?>
                ...
                <!--<td class="tar"><?php echo number_format($row['use_sp_point']); ?></td>
                <td class="tar"><?php echo number_format($row['use_ppay']); ?></td>-->
...
<!--
                    <tr>
                        ...
                        <td class="td_price fc_red">(-) <?php echo display_price($amount['usesppoint']); ?></td>
                    </tr>
                    <tr>
                        <th scope="row">마일리지</th>
                        <td class="td_price fc_red">(-) <?php echo display_price($amount['useppay']); ?></td>
                    </tr>
-->
					<tr>
