...
$sSiteCode	= $default['de_ipin_id']; // NICE신용평가정보에서 발급한 사이트코드
$sSitePw	= $default['de_ipin_pw']; // NICE신용평가정보에서 발급한 사이트패스워드
...
└────────────────────────────────────────────────────────────────────
*/
$sModulePath = MS_PLUGIN_PATH."/chekplus/IPIN2Client";
...
if ($sCPRequest == $strCPRequest) {
	if(is_mobile())
		goto_url(MS_MBBS_URL.'/register_form.php');
	else
		goto_url(MS_BBS_URL.'/register_form.php');
}
