...
$cb_encode_path = MS_PLUGIN_PATH."/chekplus/CPClient"; // NICE로부터 받은 암호화 프로그램의 위치
...
$returnurl		= MS_PLUGIN_URL."/chekplus/checkplus_success.php";	// 성공시 이동될 URL
$errorurl		= MS_PLUGIN_URL."/chekplus/checkplus_fail.php"; // 실패시 이동될 URL
