...
include_once(TB_PLUGIN_PATH.'/wz.chargepoint/config.php');
include_once(WPOT_PLUGIN_PATH.'/gender/inicis/config.php');
require_once(WPOT_PLUGIN_PATH.'/gender/inicis/libs/HttpClient.php');
require_once(WPOT_PLUGIN_PATH.'/gender/inicis/libs/json_lib.php');
...
try {
    ...
    if (strcmp('0000', $_REQUEST['resultCode']) == 0) {
        ...
        try {
            ...
            $order_action_url = https_url(TB_PLUGIN_DIR.'/wz.chargepoint/request.update.php', true);
            ...
            if ((strcmp('0000', $resultMap['resultCode']) == 0) && (strcmp($secureSignature, $resultMap['authSignature']) == 0) ) { //결제보안 추가
                ...
                require WPOT_PLUGIN_PATH.'/gender/inicis/INIStdPayResult.php';
                exit;
            } else {
