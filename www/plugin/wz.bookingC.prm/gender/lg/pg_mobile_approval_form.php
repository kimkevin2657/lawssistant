...
$LGD_RETURNURL			    = $LGD_PAY_URL.'/returnurl_mobile.php';
$LGD_KVPMISPNOTEURL         = $LGD_PAY_URL.'/note_url.php';
$LGD_KVPMISPWAPURL		    = $LGD_PAY_URL.'/mispwapurl.php?LGD_OID='.$LGD_OID;   //ISP 카드 결제시, URL 대신 앱명 입력시, 앱호출함
$LGD_KVPMISPCANCELURL       = $LGD_PAY_URL.'/cancel_url.php';
$LGD_MTRANSFERWAPURL        = $LGD_PAY_URL.'/returnurl_mobile.php';
$LGD_MTRANSFERCANCELURL     = $LGD_PAY_URL.'/cancel_url.php';
$LGD_MTRANSFERNOTEURL       = $LGD_PAY_URL.'/note_url.php';
