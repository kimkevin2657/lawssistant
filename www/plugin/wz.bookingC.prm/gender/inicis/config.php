...
if ($wzpconfig['pn_pg_test']) {
    ...
    $wzpconfig['pn_pg_mid'] = 'INIpayTest';
    $wzpconfig['pn_pg_site_key'] = '1111';
    $wzpconfig['pn_pg_sign_key'] = 'SU5JTElURV9UUklQTEVERVNfS0VZU1RS';
...
if ($is_mobile_pay) {
    ...
    $noti_url   = WZB_PLUGIN_URL.'/gender/inicis/pg_mobile_settle_common.php';
    $next_url   = WZB_PLUGIN_URL.'/gender/inicis/pg_mobile_approval.php';
    $return_url = WZB_PLUGIN_URL.'/gender/inicis/pg_mobile_return.php?bo_table='.$bo_table.'&oid=';
     ...
     * 1. 라이브러리 인클루드 *
     **************************/
    require(WZB_PLUGIN_PATH.'/gender/inicis/libs/INILib.php');
    require_once(WZB_PLUGIN_PATH.'/gender/inicis/libs/INIStdPayUtil.php');
    require_once(WZB_PLUGIN_PATH.'/gender/inicis/libs/sha256.inc.php');

    $mid = $wzpconfig['pn_pg_mid'];
    $signKey = $wzpconfig['pn_pg_sign_key'];

    $home_dir = WZB_PLUGIN_PATH.'/gender/inicis';
    ...
    /* 기타 */
    $siteDomain = WZB_PLUGIN_URL.'/gender/inicis'; //가맹점 도메인 입력
