...
$log_dir = G5_DATA_PATH.'/yeayakuplog';
...
$sql = " select * from g5_wzb_inicis_log where oid = '$oid' ";
$row = sql_fetch($sql);
...
// 로그 삭제
@sql_query(" delete from g5_wzb_inicis_log where oid = '$oid' ");
...
<div id="pay_working" style="display:none;">
     <span style="display:block; text-align:center;margin-top:120px"><img src="<?php echo WZB_PLUGIN_URL; ?>/gender/inicis/img/loading.gif" alt=""></span>
