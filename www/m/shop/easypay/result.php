...
<?
    ...
    $res_msg              = iconv('euc-kr','utf-8', $_POST["res_msg"]);          // 응답메시지        (CA, CAO, CC, CCO, CPC)
    ...
    $issuer_nm            = iconv('EUC-KR', 'UTF-8', $_POST["issuer_nm"]);        // 발급사명          (CA,          CCO     )
    $acquirer_cd          = $_POST["acquirer_cd"];      // 매입사코드        (CA,          CCO     )
    $acquirer_nm          = iconv('EUC-KR', 'UTF-8', $_POST["acquirer_nm"]);      // 매입사명          (CA,          CCO     )
