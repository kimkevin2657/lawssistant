...
<tr>
    ...
    <tr height="25">
        ...
        <td bgcolor="#FFFFFF" width="750" colspan="3">&nbsp;<input type="text" id="EP_mall_id" name="EP_mall_id" value="<?php echo $default['de_easypay_mid']; ?>" size="50" maxlength="8" class="input_F"></td>
    </tr>
    </table>
    <!-- mallinfo end -->
    ...
    <tr height="25">
        ...
        <td bgcolor="#FFFFFF" width="300">&nbsp;<input type="text" name="req_id" id="req_id" value="<?php echo $member['id']; ?>" size="50" class="input_A"></td>
    </tr>
    <tr height="25">
        <!-- [옵션] 변경사유 -->
