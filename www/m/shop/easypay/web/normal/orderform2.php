     ...
     */
    ?>
    <input type="hidden" id="EP_pay_type"       name="EP_pay_type"          value="<?php echo $od['paymethod']; ?>">         <!-- 가맹점명-->
    ...
    <input type="hidden" id="EP_mall_nm"        name="EP_mall_nm"           value="<?php echo $default['de_easypay_mid']; ?>">         <!-- 가맹점명-->
    <input type="hidden" id="EP_currency"       name="EP_currency"          value="00">       <!-- 통화코드 // 00 : 원화-->
    <input type="hidden" id="EP_return_url"     name="EP_return_url"        value="http://<?php echo $_SERVER['HTTP_HOST']; ?>/shop/easypay80_wbpay_php/web/normal/order_res.php">         <!-- 가맹점 CALLBACK URL // -->
