...
if($od_cancel_price > 0 || $od_count1 != $od_count2) {
	alert("취소할 수 있는 주문이 아닙니다.", MS_MSHOP_URL."/orderinquiryview.php?od_id=$od_id&uid=$uid");
}
...
if($od['od_tno']) {
    switch($od['od_pg']) {
        ...
        case 'kcp':
            ...
            include MS_SHOP_PATH.'/kcp/pp_ax_hub.php';
...
$sql = " update shop_order
			set shop_memo = CONCAT(shop_memo,\"\\n주문자 본인 직접 취소 - ".MS_TIME_YMDHIS." (취소이유 : {$cancel_memo})\")
		 where od_id = '$od_id' ";
sql_query($sql);
