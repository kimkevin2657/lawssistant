...
include_once(MS_MSHOP_PATH.'/settle_kcp.inc.php'); // 환경설정 파일 include
?>
<?php
/* = -------------------------------------------------------------------------- = */
...
$js_return_url = MS_MSHOP_URL.'/orderkcp.php?od_id='.$ordr_idxx;
?>
...
<script src="<?php echo MS_MSHOP_URL; ?>/kcp/approval_key.js"></script>
...
<input type="hidden" name="Ret_URL"      value="<?php echo MS_MSHOP_URL; ?>/kcp/order_approval_form.php">
<!-- 인증시 필요한 파라미터(변경불가)-->
...
<input type="hidden" name="enc_data"		value="<?php echo $enc_data; ?>">    <!-- 암호화 데이터      -->
    ...
    <div id="show_progress" style="display:none;">
        <span style="display:block; text-align:center;margin-top:120px"><img src="<?php echo MS_MSHOP_URL; ?>/img/loading.gif" alt="" ></span>
