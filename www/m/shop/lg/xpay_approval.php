...
require_once(MS_MSHOP_PATH.'/settle_lg.inc.php');
...
$LGD_RETURNURL			    = MS_MSHOP_URL.'/lg/returnurl.php';
$LGD_KVPMISPNOTEURL         = MS_MSHOP_URL.'/lg/note_url.php';
$LGD_KVPMISPWAPURL		    = MS_MSHOP_URL.'/lg/mispwapurl.php?LGD_OID='.$LGD_OID;   //ISP 카드 결제시, URL 대신 앱명 입력시, 앱호출함
$LGD_KVPMISPCANCELURL       = MS_MSHOP_URL.'/lg/cancel_url.php';
$LGD_MTRANSFERWAPURL        = MS_MSHOP_URL.'/lg/returnurl.php';
$LGD_MTRANSFERCANCELURL     = MS_MSHOP_URL.'/lg/cancel_url.php';
$LGD_MTRANSFERNOTEURL       = MS_MSHOP_URL.'/lg/note_url.php';
