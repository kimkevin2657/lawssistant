...
<div id="sod_ws">
	...
	<div class="ws_wrap">
		...
		for($i=0; $row=sql_fetch_array($result); $i++) {
			$gs_id = $row['index_no'];
			$it_href = MS_MSHOP_URL.'/view.php?gs_id='.$gs_id;
		?>
		<tr>
			...
			<td class="wish_info">
				...
				<div class="wish_del"><a href="<?php echo MS_MSHOP_URL; ?>/today.php?w=d&gs_id=<?php echo $gs_id; ?>" class="btn_small grey">삭제</a></div>
			</td>
		</tr>
		<?php } ?>
		</tbody>
