...
<form name="flogin" action="<?php echo MS_HTTPS_MBBS_URL; ?>/login_check.php" onsubmit="return flogin_submit(this);" method="post">
<div class="mb_login">
	<section class="login_fs">
		...
		<p class="mart3"><a href="<?php echo MS_MBBS_URL; ?>/register.php" class="btn_medium bx-white wfull">회원가입</a></p>
