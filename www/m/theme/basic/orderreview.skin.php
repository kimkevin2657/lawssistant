...
<form name="forderreview" id="sit_review" method="post" action="<?php echo $form_action_url; ?>" enctype="multipart/form-data" onsubmit="return forderreview_submit(this);">
...
<div class="tbl_frm01 tbl_wrap">
  ...
  <tr>
    ...
    <td><input type="file" name="photo_file_1"></td>
  </tr>
  <tr>
    <th scope="row">사진첨부 #2</th>
    <td><input type="file" name="photo_file_2"></td>
  </tr>
  <tr>
    <th scope="row">사진첨부 #3</th>
    <td><input type="file" name="photo_file_3"></td>
  </tr>
	</tbody>
	</table>
</div>
...
function forderreview_submit(f) {
	...
	if(f.wr_content.value.length < 10) {
