...
require_once(MS_MSHOP_PATH.'/settle_kcp.inc.php');

// 결제등록 요청시 사용할 입금마감일
$ipgm_date = date("Ymd", (MS_SERVER_TIME + 86400 * 5));
...
<div id="sod_fin">
	...
	require_once(MS_MSHOP_PATH.'/kcp/orderform.1.php');
	?>
	...
	require_once(MS_MSHOP_PATH.'/kcp/orderform.2.php');
	?>
