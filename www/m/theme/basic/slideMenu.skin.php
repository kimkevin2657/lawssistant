...
<div id="slideMenu">
     <span class="sm_close ionicons ion-ios-close-empty" onclick="history.go(-1);"></span>
	<dl class="top_btn">
...
$(function(){
	...
	$(".btn_sidem").click(function () {
		$("#slideMenu, .mobiledominner").addClass("m_open");
	...
	window.onhashchange = function () {
		if(location.hash != "#Menu") {
			$("#slideMenu, .mobiledominner").removeClass("m_open");
			$(".mobiledominner").css({
				height:'100%'
			});
		}
