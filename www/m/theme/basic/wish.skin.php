...
<div id="sod_ws">
	...
	<div class="ws_wrap">
		...
		<tr>
			...
			<td class="wish_img"><a href="<?php echo MS_MSHOP_URL; ?>/view.php?gs_id=<?php echo $row['gs_id'];?>"><?php echo get_it_image($row['gs_id'], $row['simg1'], 60, 60); ?></a></td>
			<td class="wish_info">
				<div class="wish_gname">
					<a href="<?php echo MS_MSHOP_URL; ?>/view.php?gs_id=<?php echo $row['gs_id'];?>"><?php echo cut_str($row['gname'],60);?></a>
					<div class="bold mart5"><?php echo mobile_price($row['gs_id']);?></div>
				</div>
				<div class="wish_del"><a href="<?php echo MS_MSHOP_URL; ?>/wishupdate.php?w=d&wi_id=<?php echo $row['wi_id'];?>" class="btn_small grey">삭제</a></div>
			</td>
		</tr>
		<?php } ?>
		</tbody>
