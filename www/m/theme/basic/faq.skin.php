...
<div class="s_cont">
	<select name="faq_type" class="faq_sch" onchange="location=this.value;">
		<option value="<?php echo MS_MBBS_URL; ?>/faq.php">전체보기</option>
		<?php
		...
		?>
		<option value="<?php echo MS_MBBS_URL; ?>/faq.php?faqcate=<?php echo $row['index_no']; ?>"<?php echo $selected; ?>><?php echo $row['catename']; ?></option>
		<?php } ?>
	</select>
	<div class="faq_li">
		<ul>
