...
require_once(MS_MSHOP_PATH.'/settle_inicis.inc.php');
?>
...
<div id="sod_fin">
	...
	require_once(MS_MSHOP_PATH.'/inicis/orderform.1.php');
	?>
	...
	require_once(MS_MSHOP_PATH.'/inicis/orderform.2.php');
	?>
...
function payment_check(f)
{
	...
	if(f.od_settle_case.value == '실시간계좌이체') {
		if(tot_price < 150) {
