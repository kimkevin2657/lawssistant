...
<div class="s_cont">
	...
	<div class="fregister_agree">
		<h3 class="fr_tit">회원가입 약관<a href="javascript:win_open('<?php echo MS_MBBS_URL; ?>/provision.php','pop_provision');" class="btn_small bx-white">전문보기</a></h3>
	...
	<div class="fregister_agree">
		<h3 class="fr_tit">개인정보 수집 및 이용<a href="javascript:win_open('<?php echo MS_MBBS_URL; ?>/policy.php','pop_policy');" class="btn_small bx-white">전문보기</a></h3>
		<div class=" tbl_head02 tbl_wrap"><?php Theme::get_theme_part(MS_THEME_PATH,"/policy-table.skin.php"); ?></div>
		<p class="agree_chk"><input name="agree2" type="checkbox" value="1" id="agree22" class="css-checkbox lrg"><label for="agree22" class="css-label">개인정보 수집 및 이용 내용에 동의합니다.</label></p>
	</div>
	<div class="btn_confirm">
		...
		<?php } else { ?>
        <button type="submit" name="join_type" value="fb_none" class="btn_medium wset">일반회원가입</button>
        <button type="submit" name="join_type" value="fb_0" class="btn_medium wset">엑셀회원가입</button>
            <?php if(  date('Y-m-d') < '2019-03-13' ): ?>
        <button type="submit" name="join_type" value="fb_198" class="btn_medium wset">타법인 회원가입</button>
        <button type="submit" name="join_type" value="fb_33" class="btn_medium wset">타법인~9/30회원가입</button>
        <button type="submit" name="join_type" value="fb_0" class="btn_medium wset">타법인10/1~회원가입</button>
            <?php endif; ?>
