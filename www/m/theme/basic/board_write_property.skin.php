...
<form name="fwrite" id="fwrite" method="post" action="<?php echo $form_action_url; ?>" onsubmit="return fboardform_submit(this);" autocomplete="off" autocomplete="off" enctype="MULTIPART/FORM-DATA">
...
<div class="tbl_frm01 tbl_wrap">
	...
	<tr>
		<th scope="row">주소</th>
			<td>
				<div>
					<input type="text" name="b_zip" value="<?php echo $write['b_zip']; ?>" required itemname="우편번호" class="frm_input required" maxLength="5" size="8"> <a href="javascript:win_zip('fwrite', 'b_zip', 'b_addr1', 'b_addr2', 'b_addr3', 'b_addr_jibeon');" class="btn_small grey">주소검색</a>
				</div>
				<div class="padt5">
