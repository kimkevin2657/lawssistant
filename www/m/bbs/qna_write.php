...
if($_POST['mode'] == 'w') {
	...
	if($email) {
		ob_start();
		include_once(MS_BBS_PATH.'/write_update_mail.php');
	...
	alert("정상적으로 접수 되었습니다. 빠른 시간안에 답변드리겠습니다", MS_MBBS_URL."/qna_list.php");
}
...
$form_action_url = MS_HTTPS_MBBS_URL.'/qna_write.php';
Theme::get_theme_part(MS_MTHEME_PATH,'/qna_write.skin.php');
