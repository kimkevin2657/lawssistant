...
if($w == "") {
	...
	if($default['de_certify_use']) {
		if(get_session("allow") != 'Y') {
			alert('정상적인 접근이 아닙니다.', MS_MBBS_URL.'/register.php');
		}
...
$register_action_url = MS_HTTPS_MBBS_URL.'/register_form_update.php';
Theme::get_theme_part(MS_MTHEME_PATH,'/register_form.skin.php');
