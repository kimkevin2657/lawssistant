...
if($_POST['mode'] == 'w') {
	...
	goto_url(MS_MBBS_URL."/qna_read.php?index_no=$index_no");
}
...
$form_action_url = MS_HTTPS_MBBS_URL.'/qna_modify.php';
Theme::get_theme_part(MS_MTHEME_PATH,'/qna_modify.skin.php');
