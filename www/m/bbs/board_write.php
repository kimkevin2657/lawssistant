...
$form_action_url = MS_HTTPS_MBBS_URL.'/board_write_update.php';
if($boardid=="102") {
Theme::get_theme_part(MS_MTHEME_PATH,'/board_write_property.skin.php');
}else{
Theme::get_theme_part(MS_MTHEME_PATH,'/board_write.skin.php');
}
